...
(function () {
  ...
  document.head.insertAdjacentHTML('beforeend', "<style id=\"mkt-style\">.mk-monthbar{display:flex;align-items:center;gap:12px;flex-wrap:wrap;margin-bottom:16px}\n.mk-monthbar .mk-mnav{display:inline-flex;align-items:center;gap:4px;background:var(--surface-1);border:1px solid var(--border);border-radius:10px;padding:3px}\n.mk-monthbar .mk-mnav button{width:1.5em;height:1.5em;border-radius:8px;display:grid;place-items:center;font-size:clamp(20px,0.08375vw + 18.856px,21px);line-height:1.1;color:var(--text-2)}\n.mk-monthbar .mk-mnav button:hover{background:var(--surface-3);color:var(--text-1)}\n.mk-monthbar .mk-mnav h2{font-size:clamp(20px,0.08375vw + 18.856px,21px);font-weight:600;min-width:9em;text-align:center;letter-spacing:-.2px}\n.mk-monthbar .mk-hint{font-size:clamp(16px,0.08375vw + 14.856px,17px);color:var(--muted)}\n.mk-monthbar .grow{flex:1}\n.mk-alerts{display:grid;grid-template-columns:repeat(auto-fill,minmax(clamp(300px,6.281vw + 214.2px,375px),1fr));gap:12px;margin-bottom:18px}\n.mk-alert{display:flex;gap:12px;align-items:center;width:100%;text-align:left;font:inherit;padding:12px 14px;border-radius:var(--radius);background:var(--surface-1);border:1px solid var(--border);cursor:pointer;transition:.12s;position:relative;overflow:hidden}\n.mk-alert:hover{transform:translateY(-1px);box-shadow:0 2px 4px rgba(11,11,11,.06),0 8px 24px rgba(11,11,11,.09)}\n.mk-alert .mk-al-days{flex:0 0 auto;width:clamp(52px,0.5025vw + 45.136px,58px);height:clamp(52px,0.5025vw + 45.136px,58px);border-radius:12px;display:grid;place-items:center;text-align:center;line-height:1;font-weight:600;font-size:clamp(25px,0.1675vw + 22.712px,27px);letter-spacing:-.5px;font-variant-numeric:tabular-nums}\n.mk-alert .mk-al-days small{display:block;font-size:clamp(14px,0.08375vw + 12.856px,15px);font-weight:600;letter-spacing:.3px;margin-top:3px;opacity:.85}\n.mk-alert .mk-al-info{flex:1;min-width:0;display:flex;flex-direction:column}\n.mk-alert .mk-al-name,.mk-alert .mk-al-sub{display:block}\n.mk-al-days.comem{background:#fbe4ee;color:#b3125c}.mk-al-days.promo{background:#fdf1dc;color:#9a5e00}.mk-al-days.now{background:var(--critical);color:#fff}\n:root[data-theme=\"dark\"] .mk-al-days.comem{background:#3d1229;color:#ff9ccb}:root[data-theme=\"dark\"] .mk-al-days.promo{background:#33280f;color:#fab219}\n@media (prefers-color-scheme: dark){:root:not([data-theme=\"light\"]) .mk-al-days.comem{background:#3d1229;color:#ff9ccb}:root:not([data-theme=\"light\"]) .mk-al-days.promo{background:#33280f;color:#fab219}}\n.mk-al-days svg{width:22px;height:22px}\n.mk-alert .mk-al-name{font-weight:600;font-size:clamp(16px,0.08375vw + 14.856px,17px);line-height:1.3;overflow-wrap:anywhere}\n.mk-alert .mk-al-sub{font-size:clamp(15px,0.08375vw + 13.856px,16px);color:var(--text-2);margin-top:3px;line-height:1.35}\n.mk-alert .mk-al-sub b{color:var(--critical-ink);font-weight:600}\n.mk-alert.hoje{border-color:var(--critical);background:var(--crit-wash)}\n.mk-alert.hoje .mk-al-sub{color:var(--text-1)}\n.mk-kpis{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:12px;margin-bottom:18px}\n.mk-kpi{background:var(--surface-1);border:1px solid var(--border);border-radius:var(--radius);padding:14px 16px;cursor:pointer;transition:.12s;position:relative;overflow:hidden;text-align:left;min-width:0}\n.mk-kpi:hover{transform:translateY(-1px);box-shadow:0 2px 4px rgba(11,11,11,.06),0 8px 24px rgba(11,11,11,.09)}\n.mk-kpi::before{content:'';position:absolute;left:0;top:0;right:0;height:3px;background:var(--kc,var(--brand))}\n.mk-kpi{font:inherit;display:block;width:100%}\n.mk-kpi .k-label,.mk-kpi .k-val,.mk-kpi .k-foot{display:block}\n.mk-kpi .k-label{color:var(--text-2);font-size:clamp(15px,0.08375vw + 13.856px,16px);font-weight:600;display:flex;align-items:center;gap:6px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}\n.mk-kpi .k-val{font-size:clamp(39px,0.335vw + 34.424px,43px);font-weight:700;letter-spacing:-1px;margin-top:6px;line-height:1.08;font-variant-numeric:tabular-nums}\n.mk-kpi .k-foot{font-size:clamp(16px,0.08375vw + 14.856px,17px);color:var(--muted);margin-top:7px;font-weight:400;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}\n.mk-kpi .k-foot b{color:var(--critical-ink)}\n.mk-kpi.bad .k-val{color:var(--critical-ink)}\n.mk-section{margin-bottom:22px}\n.mk-section .section-title{margin:4px 0 12px;flex-wrap:wrap;gap:8px 12px}\n.mk-section .section-title h2{font-size:clamp(20px,0.08375vw + 18.856px,21px)}\n.mk-section .section-title .st-sub{font-size:clamp(16px,0.08375vw + 14.856px,17px);color:var(--muted);font-weight:400}\n.mk-legend{display:flex;gap:10px;flex-wrap:wrap;align-items:center}\n.mk-legend .lg{display:inline-flex;align-items:center;gap:5px;font-size:clamp(15px,0.08375vw + 13.856px,16px);color:var(--text-2);font-weight:600;cursor:pointer;padding:3px 8px;border-radius:20px;border:1px solid transparent;font-family:inherit}\n.mk-legend button.lg:hover{background:var(--surface-3);border-color:var(--border)}\n.mk-legend .lg.off{opacity:.5;text-decoration:line-through}\n.mk-legend span.lg{cursor:default}\n.mk-legend .dot{width:9px;height:9px;border-radius:3px}\n.mk-legend .vst{width:12px;height:12px;border-radius:50%;background:var(--good);color:#fff;\nfont-size:9px;font-weight:700;line-height:12px;text-align:center;font-style:normal;flex:0 0 auto}\n.mk-legend .dot.dash{background:transparent;border:1.5px dashed #898781}\n.mk-cal{background:var(--surface-1);border:1px solid var(--border);border-radius:var(--radius);overflow:hidden}\n.mk-cal-head{display:grid;grid-template-columns:repeat(7,minmax(0,1fr))}\n.mk-cal-head div{padding:10px 8px;text-align:center;font-size:clamp(14px,0.08375vw + 12.856px,15px);text-transform:uppercase;letter-spacing:.4px;color:var(--muted);font-weight:600;border-bottom:1px solid var(--border)}\n.mk-cal-head div.wknd{color:var(--brand-ink)}\n.mk-cal-grid{display:grid;grid-template-columns:repeat(7,minmax(0,1fr))}\n.mk-cell{min-height:clamp(130px,0.9213vw + 117.42px,141px);border-right:1px solid var(--border-2);border-bottom:1px solid var(--border-2);padding:6px 7px;cursor:pointer;transition:background .12s;min-width:0;position:relative}\n.mk-cell:nth-child(7n){border-right:none}\n.mk-cell:hover{background:var(--surface-2)}\n.mk-cell.out{background:var(--surface-2)}\n.mk-cell.out .dn{opacity:.35}\n.mk-cell.out .mk-ev{opacity:.75}\n.mk-cell.wknd:not(.out){background:color-mix(in srgb,var(--brand-wash) 35%,transparent)}\n.mk-cell .dn{font-size:clamp(16px,0.08375vw + 14.856px,17px);font-weight:600;color:var(--text-2);display:inline-grid;place-items:center;min-width:1.7em;height:1.7em;padding:0 .25em;border-radius:999px}\n.mk-cell.today .dn{background:var(--brand);color:#fff}\n.mk-cell.drag-over{outline:2px dashed var(--brand);outline-offset:-3px;background:var(--brand-wash)}\n.mk-date{display:flex;align-items:flex-start;gap:5px;margin-top:4px;padding:3px 7px;border-radius:6px;background:#fbe4ee;color:#b3125c;font-size:clamp(14px,0.08375vw + 12.856px,15px);font-weight:600;letter-spacing:.2px;line-height:1.25;cursor:pointer}\n.mk-date span{display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;overflow-wrap:anywhere}\n.mk-date svg{margin-top:1px}\n.mk-date.promo{background:#fdf1dc;color:#9a5e00}\n:root[data-theme=\"dark\"] .mk-date{background:#3d1229;color:#ff9ccb}\n:root[data-theme=\"dark\"] .mk-date.promo{background:#33280f;color:#fab219}\n@media (prefers-color-scheme: dark){:root:not([data-theme=\"light\"]) .mk-date{background:#3d1229;color:#ff9ccb}:root:not([data-theme=\"light\"]) .mk-date.promo{background:#33280f;color:#fab219}}\n.mk-date svg{width:11px;height:11px;flex:0 0 auto}\n.mk-ev{display:flex;align-items:flex-start;gap:5px;font-size:clamp(14px,0.08375vw + 12.856px,15px);font-weight:600;padding:4px 7px;border-radius:5px;margin-top:4px;cursor:grab;border:1px solid transparent;min-width:0;line-height:1.25;overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical}\n.mk-ev>*{flex:0 0 auto}\n.mk-ev .n{margin-right:.4em}\n.mk-ev .n::after{content:'\\00a0'}\n.mk-ev:active{cursor:grabbing}\n.mk-ev .n{font-weight:600;font-variant-numeric:tabular-nums;flex:0 0 auto;opacity:.85}\n.mk-ev .tt{overflow:hidden;text-overflow:ellipsis;min-width:0}\n.mk-ev.ideia{border-style:dashed;border-color:#898781;color:var(--text-2);background:transparent}\n.mk-ev.late{background:var(--crit-wash)!important;color:var(--critical-ink)!important;border-color:var(--critical)}\n.mk-ev.hoje{box-shadow:0 0 0 1.5px var(--brand) inset}\n.mk-ev.start{background:transparent;border:1px dotted var(--border);color:var(--muted);font-weight:400}\n.mk-more{font-size:clamp(14px,0.08375vw + 12.856px,15px);color:var(--brand-ink);margin-top:4px;font-weight:600;cursor:pointer}\n.mk-more:hover{text-decoration:underline}\n.mk-kanban{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:12px;align-items:start}\n.mk-kanban .kcol{min-width:0}\n.mk-kanban .kcol{padding:10px;border-top:3px solid var(--sc,var(--border))}\n.mk-kanban .kcol h3{font-size:clamp(16px,0.08375vw + 14.856px,17px)}\n.mk-kanban .kcol h3 .count{cursor:pointer;background:var(--surface-3);padding:1px 8px;border-radius:10px;font-size:clamp(14px,0.08375vw + 12.856px,15px);font-weight:600;margin-left:auto;color:var(--muted);font-family:inherit}\n.mk-kanban .kcol h3 .count:hover{background:var(--brand-wash);color:var(--brand-ink)}\n.mk-kanban .kempty{font-size:clamp(16px,0.08375vw + 14.856px,17px);color:var(--muted);text-align:center;padding:14px 6px;border:1px dashed var(--border);border-radius:8px}\n.mk-card{background:var(--surface-1);border:1px solid var(--border);border-radius:var(--radius-s);padding:10px 11px;margin-bottom:9px;box-shadow:0 1px 2px rgba(11,11,11,.04);cursor:grab;transition:.12s;position:relative;overflow:hidden}\n.mk-card:hover{border-color:var(--brand);box-shadow:0 2px 8px rgba(11,11,11,.08)}\n.mk-card:active{cursor:grabbing}\n.mk-card.dragging{opacity:.5}\n.mk-card .mk-rej{display:flex;align-items:center;gap:6px;background:var(--critical);color:#fff;font-size:clamp(14px,0.08375vw + 12.856px,15px);font-weight:600;padding:4px 9px;margin:-10px -11px 9px;letter-spacing:.2px}\n.mk-card .mk-rej span{font-weight:400;min-width:0;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;line-height:1.3}\n.mk-card .mk-rej{align-items:flex-start}\n.mk-card .mk-hoje{display:flex;align-items:center;gap:6px;background:var(--brand);color:#fff;font-size:clamp(14px,0.08375vw + 12.856px,15px);font-weight:600;padding:4px 9px;margin:-10px -11px 9px}\n.mk-card .mk-late{display:flex;align-items:center;gap:6px;background:var(--crit-wash);color:var(--critical-ink);font-size:clamp(14px,0.08375vw + 12.856px,15px);font-weight:600;padding:4px 9px;margin:-10px -11px 9px}\n.mk-card .mk-ch{display:flex;align-items:center;justify-content:space-between;gap:6px;margin-bottom:6px}\n.mk-num{font-size:clamp(15px,0.08375vw + 13.856px,16px);font-weight:600;color:var(--text-2);font-variant-numeric:tabular-nums;letter-spacing:.2px;background:var(--surface-3);padding:1px 7px;border-radius:5px;flex:0 0 auto}\n.mk-cat{font-size:clamp(14px,0.08375vw + 12.856px,15px);font-weight:600;padding:2px 8px;border-radius:12px;line-height:1.3;min-width:0;max-width:100%;text-align:right;overflow-wrap:anywhere}\n.mk-cron-card .ch{min-width:0}\n.mk-cron-card .mk-cat,.mk-card .mk-cat{white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:100%;flex:0 1 auto}\n.mk-card .mk-ch{min-width:0}\n.mk-card .mk-title{font-weight:600;font-size:clamp(16px,0.08375vw + 14.856px,17px);line-height:1.35;overflow-wrap:anywhere;margin-bottom:7px}\n.mk-chan{display:flex;gap:4px;flex-wrap:wrap;align-items:center}\n.ci{position:relative}\n.mk-chan .ci{width:1.8em;height:1.8em;border-radius:6px;display:grid;place-items:center;flex:0 0 auto;font-size:clamp(14px,0.08375vw + 12.856px,15px)}\n.ci .bd{position:absolute;right:-3px;bottom:-3px;width:8px;height:8px;border-radius:50%;background:#e00a35;border:1.5px solid var(--surface-1);font-size:0;overflow:hidden}\n.mk-chan .ci svg{width:1.06em;height:1.06em;fill:var(--tinta,#fff)}\n.mk-chan .ci.big{width:2.4em;height:2.4em;border-radius:7px}\n.mk-chan .ci.big svg{width:1.4em;height:1.4em}\n.mk-chan .ci .lt{color:var(--tinta,#fff);font-size:.8em;font-weight:700;line-height:1.15;max-width:100%;overflow:hidden;text-align:center}\n.mk-card .mk-foot{display:flex;align-items:center;gap:6px;margin-top:8px;justify-content:space-between;min-width:0}\n.mk-card .mk-foot .left{display:flex;align-items:center;gap:6px;min-width:0;flex-wrap:wrap}\n.mk-pill{font-size:clamp(14px,0.08375vw + 12.856px,15px);font-weight:600;padding:2px 7px;border-radius:5px;background:var(--surface-3);color:var(--text-2);white-space:nowrap;font-variant-numeric:tabular-nums}\n.mk-pill.late{background:var(--crit-wash);color:var(--critical-ink)}\n.mk-pill.warn{background:var(--warn-wash);color:color-mix(in srgb,var(--warning) 60%,var(--text-1))}\n.mk-pill.wrap{white-space:normal;overflow-wrap:anywhere;text-align:left}\n.mk-prog{display:flex;align-items:center;gap:6px;font-size:clamp(14px,0.08375vw + 12.856px,15px);color:var(--muted);font-weight:600;font-variant-numeric:tabular-nums;white-space:nowrap}\n.mk-prog i{display:block;width:44px;height:4px;background:var(--surface-3);border-radius:3px;overflow:hidden}\n.mk-prog i b{display:block;height:100%;background:var(--good)}\n.mk-card .mk-actions{display:flex;gap:6px;margin-top:9px}\n.mk-card .mk-actions .btn{flex:1;justify-content:center;padding:6px 8px;font-size:clamp(15px,0.08375vw + 13.856px,16px);box-shadow:none}\n.btn.ok{background:var(--good)}.btn.ok:hover{background:#0a8a0a}\n.btn.danger{background:var(--surface-1);color:var(--critical-ink);border:1px solid var(--critical);box-shadow:none}.btn.danger:hover{background:var(--crit-wash)}\n.mk-wait{font-size:clamp(14px,0.08375vw + 12.856px,15px);color:var(--muted);margin-top:8px;display:flex;align-items:center;gap:5px}\n.mk-newcard{width:100%;border:1px dashed var(--border);border-radius:8px;padding:9px;font-size:clamp(16px,0.08375vw + 14.856px,17px);font-weight:600;color:var(--text-2);margin-top:2px;transition:.12s}\n.mk-newcard:hover{border-color:var(--brand);color:var(--brand-ink);background:var(--brand-wash)}\n.mk-cron{display:grid;grid-template-columns:repeat(auto-fill,minmax(clamp(300px,4.02vw + 245.09px,348px),1fr));gap:12px}\n.mk-cron-card{background:var(--surface-1);border:1px solid var(--border);border-radius:var(--radius);padding:14px 15px;min-width:0}\n.mk-cron-card .ch{display:flex;align-items:center;gap:8px;margin-bottom:6px;width:100%;text-align:left;font:inherit;cursor:pointer;border-radius:8px}\n.mk-cron-card .ch:hover{background:var(--surface-2)}\n.mk-cron-card .ch .grow{flex:1}\n.mk-cron-card .ct{display:block;width:100%;text-align:left;font:inherit;font-weight:600;font-size:clamp(16px,0.08375vw + 14.856px,17px);line-height:1.35;cursor:pointer;overflow-wrap:anywhere;margin-bottom:8px}\n.mk-cron-card .ct:hover{color:var(--brand-ink)}\n.mk-step{display:flex;align-items:center;gap:8px;padding:8px 4px;border-bottom:1px solid var(--border-2);font-size:clamp(16px,0.08375vw + 14.856px,17px);min-width:0;flex-wrap:wrap}\n.mk-step>.st{flex:1 1 auto;min-width:0;overflow-wrap:normal;word-break:normal;hyphens:none}\n.mk-step:last-child{border-bottom:none}\n.mk-step .st{flex:1;min-width:0;overflow-wrap:anywhere;cursor:pointer;text-align:left;font:inherit;padding:0}\n.mk-step button.st:hover{color:var(--brand-ink)}\nbody[data-route=\"marketing\"] .minichk:disabled,#modal .minichk:disabled{cursor:default;opacity:.55}\n.mk-step.done .st{text-decoration:line-through;color:var(--muted)}\n.mk-step .sd{font-size:clamp(14px,0.08375vw + 12.856px,15px);color:var(--muted);font-variant-numeric:tabular-nums;white-space:nowrap}\n.mk-step .sd.late{color:var(--critical-ink);font-weight:600}\n.mk-step .av.xs{width:2em;height:2em;font-size:clamp(12px,0.08375vw + 10.856px,13px);flex:0 0 auto}\n.mk-cron-foot{display:flex;align-items:center;gap:8px;margin-top:10px;justify-content:space-between;flex-wrap:wrap}\n.mk-cron-foot .mk-prog i{width:80px}\n.mk-rot{display:grid;grid-template-columns:repeat(7,minmax(0,1fr));gap:8px}\n.mk-rot-col{background:var(--surface-2);border:1px solid var(--border);border-radius:10px;padding:8px;min-height:90px;min-width:0}\n.mk-rot-col.today{border-color:var(--brand);box-shadow:0 0 0 1px var(--brand) inset;background:var(--surface-1)}\n.mk-rot-col h4{font-size:clamp(15px,0.08375vw + 13.856px,16px);color:var(--text-2);margin:0 0 6px;font-weight:600;display:flex;justify-content:space-between;align-items:center}\n.mk-rot-col h4 span{color:var(--muted);font-weight:600;font-variant-numeric:tabular-nums;font-size:clamp(14px,0.08375vw + 12.856px,15px)}\n.mk-rot-col h4 .hj{background:var(--brand);color:#fff;font-size:clamp(14px,0.08375vw + 12.856px,15px);font-weight:600;padding:1px 6px;border-radius:10px;letter-spacing:.3px}\n.mk-rot-item{display:flex;align-items:flex-start;gap:7px;padding:6px 4px;border-radius:7px;cursor:pointer;font-size:clamp(16px,0.08375vw + 14.856px,17px);line-height:1.35;transition:.12s;min-width:0;width:100%;text-align:left;font-family:inherit}\n.mk-rot-item.somente-leitura{cursor:default;opacity:.72}\n.mk-rot-item.somente-leitura .minichk{border-style:dashed;cursor:default}\n.mk-rot-item:hover{background:var(--surface-3)}\n.mk-step-edit .minichk,.mk-rot-item .minichk{position:relative}\n.mk-step-edit .minichk::after,.mk-rot-item .minichk::after{\ncontent:'';position:absolute;top:-5px;left:-5px;\nwidth:calc(1.15em + 13px);height:calc(1.15em + 13px)}\n.mk-rot-item .rt{flex:1;min-width:0;overflow-wrap:break-word}\n.mk-rot-item.done .rt{text-decoration:line-through;color:var(--muted)}\n.mk-rot-item .av.xs{width:2em;height:2em;font-size:clamp(12px,0.08375vw + 10.856px,13px);flex:0 0 auto;margin-top:1px}\n.mk-rot-empty{font-size:clamp(14px,0.08375vw + 12.856px,15px);color:var(--muted);text-align:center;padding:10px 4px}\n.mk-rot-bar{height:6px;background:var(--surface-3);border-radius:3px;overflow:hidden;width:120px}\n.mk-rot-bar b{display:block;height:100%;background:var(--good)}\n.mk-rot-hint,.mk-cal-hint{display:none}\n@media (max-width:760px){.mk-cal-hint{display:inline}}\n@media (max-width:1200px){.mk-rot-hint{display:inline}}\n.mk-cfg{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px}\n.mk-cfg-card{background:var(--surface-1);border:1px solid var(--border);border-radius:var(--radius);padding:14px 16px;cursor:pointer;transition:.12s;text-align:left;min-width:0}\n.mk-cfg-card:hover{transform:translateY(-1px);border-color:var(--brand)}\n.mk-cfg-card{font:inherit;display:block;width:100%}\n.mk-cfg-card .h{font-size:clamp(16px,0.08375vw + 14.856px,17px);font-weight:600;display:flex;align-items:center;gap:8px}\n.mk-cfg-card .h .count{margin-left:auto;background:var(--surface-3);color:var(--text-2);font-size:clamp(14px,0.08375vw + 12.856px,15px);font-weight:600;padding:1px 8px;border-radius:10px}\n.mk-cfg-card .p{display:block;font-size:clamp(15px,0.08375vw + 13.856px,16px);color:var(--muted);margin-top:4px}\n.mk-cfg-card .prev{display:flex;gap:5px;flex-wrap:wrap;margin-top:10px}\n.modal.wide{max-width:min(1280px,92vw)}\n@media (min-width:1900px){ .modal.wide{max-width:min(2010px,92vw)} }\n.mk-mhead{display:flex;align-items:center;gap:10px;padding:18px 22px;border-bottom:1px solid var(--border);flex-wrap:wrap}\n.mk-mhead .mk-num{font-size:clamp(16px,0.08375vw + 14.856px,17px);padding:3px 9px}\n.mk-mhead h3{font-size:clamp(20px,0.08375vw + 18.856px,21px);font-weight:600;flex:1 1 200px;min-width:0;overflow-wrap:anywhere}\n.mk-mhead .icon-btn{margin-left:auto;flex:0 0 auto}\n.mk-mhead .tag{font-size:clamp(16px,0.08375vw + 14.856px,17px)}\n.mk-mgrid{display:grid;grid-template-columns:1.5fr 1fr;gap:20px 24px;padding:20px 22px}\n.mk-mgrid .colA{grid-column:1;grid-row:1}\n.mk-mgrid .colB{grid-column:1;grid-row:2}\n.mk-mgrid .colC{grid-column:2;grid-row:1/span 2}\n@media (min-width:1900px){\n.mk-mgrid{grid-template-columns:1fr 1.55fr 0.8fr;gap:26px;padding:22px 26px;align-items:start}\n.mk-mgrid .colA{grid-column:1;grid-row:1}\n.mk-mgrid .colB{grid-column:2;grid-row:1}\n.mk-mgrid .colC{grid-column:3;grid-row:1}\n.mk-mgrid .colA,.mk-mgrid .colB{\nborder-right:1px solid var(--border-2);padding-right:26px;\nmargin-right:-13px;box-sizing:border-box}\n.mk-mgrid{column-gap:26px}\n}\n.mk-mgrid>*{min-width:0}\n.mk-mgrid .col{display:flex;flex-direction:column;gap:15px}\n@media (min-width:901px) and (max-width:1899px){ .mk-mgrid .colC .mk-side{flex:1} }\n.mk-mgrid #f_desc{min-height:7.5em;max-height:40vh;resize:vertical}\n.mk-side{background:var(--surface-2);border:1px solid var(--border-2);border-radius:12px;padding:14px;display:flex;flex-direction:column;gap:13px}\n.mk-side .field label{font-size:clamp(15px,0.08375vw + 13.856px,16px)}\n.mk-side .field input,.mk-side .field select{background:var(--surface-1);padding:8px 10px;font-size:clamp(16px,0.08375vw + 14.856px,17px)}\n.mk-datebox{display:grid;grid-template-columns:1fr 1fr;gap:8px}\n.mk-datebox .db{background:var(--surface-1);border:1px solid var(--border);border-radius:8px;padding:8px 10px;min-width:0}\n.mk-datebox .db label{display:block;font-size:clamp(14px,0.08375vw + 12.856px,15px);font-weight:600;color:var(--muted);margin-bottom:3px;text-transform:uppercase;letter-spacing:.3px}\n.mk-datebox .db b{font-size:clamp(16px,0.08375vw + 14.856px,17px);font-weight:600;font-variant-numeric:tabular-nums}\n.mk-datebox .db b.late{color:var(--critical-ink)}\n.mk-datebox .db small{display:block;font-size:clamp(14px,0.08375vw + 12.856px,15px);color:var(--muted)}\n.mk-datebox .db.auto{border-style:dashed}\n.mk-drive{display:flex;gap:6px;align-items:center}\n.mk-drive code{flex:1;min-width:0;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:clamp(15px,0.08375vw + 13.856px,16px);background:var(--surface-1);border:1px solid var(--border);border-radius:8px;padding:8px 10px;overflow-wrap:anywhere;line-height:1.4}\n.mk-feitos{display:flex;flex-wrap:wrap;gap:7px}\n.mk-feitos .chip-feito{display:inline-flex;align-items:center;gap:7px;padding:5px 12px 5px 6px;\nborder:1px solid var(--border);border-radius:999px;background:var(--surface-1);\nfont:inherit;font-size:clamp(15px,0.08375vw + 13.856px,16px);font-weight:600;color:var(--text-1);cursor:pointer;transition:.12s}\n.mk-feitos .chip-feito:hover:not(:disabled){background:var(--surface-3)}\n.mk-feitos .chip-feito:disabled{cursor:default;opacity:.7}\n.mk-feitos .chip-feito.on{border-color:var(--good);background:var(--good-wash,color-mix(in srgb,var(--good) 10%,transparent));color:var(--good-ink)}\n.mk-feitos .chip-feito .pubchk{flex:0 0 auto;width:1.35em;height:1.35em;border-radius:50%;\nborder:2px solid var(--border-2,#c9c7c1);display:grid;place-items:center;\nfont-size:.8em;font-weight:700;color:transparent;line-height:1;transition:.12s}\n.mk-feitos .chip-feito.on .pubchk{background:var(--good);border-color:var(--good);color:#fff}\n.mk-feitos .chip-feito .nm{min-width:0}\n.mk-feitos .chip-feito .sr{position:absolute;width:1px;height:1px;overflow:hidden;clip-path:inset(50%);white-space:nowrap}\n.mk-feitos .chip-feito .ci{width:1.8em;height:1.8em;border-radius:6px;display:grid;place-items:center;font-size:clamp(14px,0.08375vw + 12.856px,15px)}\n.mk-feitos .chip-feito .ci svg{width:1.06em;height:1.06em;fill:var(--tinta,#fff)}\n.mk-feitos .chip-feito .ci .lt{color:var(--tinta,#fff);font-size:.8em;font-weight:700;line-height:1.15;max-width:100%;overflow:hidden;text-align:center}\n.mk-chan .ci.ok::after{content:'\u2713';position:absolute;right:-4px;top:-4px;\nwidth:12px;height:12px;border-radius:50%;background:var(--good);color:#fff;\nfont-size:9px;font-weight:700;line-height:12px;text-align:center;\nborder:1.5px solid var(--surface-1);box-sizing:border-box}\n.mk-chanpick{display:flex;flex-wrap:wrap;gap:7px}\n.mk-chanpick .chip-pick{gap:7px;padding:5px 11px 5px 5px;font-family:inherit}\n.mk-chanpick .chip-pick:disabled{cursor:default;opacity:.7}\n.mk-chanpick .chip-pick .ci{width:1.8em;height:1.8em;border-radius:6px;display:grid;place-items:center;font-size:clamp(14px,0.08375vw + 12.856px,15px)}\n.mk-chanpick .chip-pick .ci svg{width:1.06em;height:1.06em;fill:var(--tinta,#fff)}\n.mk-chanpick .chip-pick .ci .lt{color:var(--tinta,#fff);font-size:.8em;font-weight:700;line-height:1.15;max-width:100%;overflow:hidden;text-align:center}\n.mk-chanpick .chip-pick.on::before{content:none}\n.mk-chanpick .chip-pick.on{box-shadow:0 0 0 2px var(--brand) inset}\n.mk-links .linkrow{display:flex;align-items:center;gap:6px;margin-bottom:6px}\n.mk-links .linkrow a{flex:1;min-width:0;display:flex;align-items:center;gap:8px;overflow:hidden;text-decoration:none;color:var(--brand-ink);background:var(--surface-3);padding:7px 10px;border-radius:8px;font-size:clamp(16px,0.08375vw + 14.856px,17px);font-weight:600}\n.mk-links .linkrow a:hover{text-decoration:underline}\n.mk-links .linkrow a>span:first-child{min-width:0;overflow-wrap:anywhere;flex:1 1 auto}\n.mk-links .linkrow a .u{color:var(--muted);font-weight:400;font-size:clamp(14px,0.08375vw + 12.856px,15px);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;min-width:0}\n.mk-links .linkrow a .ext{margin-left:auto;flex:0 0 auto;width:12px;height:12px;fill:none;stroke:currentColor;stroke-width:2}\n.mk-histbox{border:1px solid var(--border);border-radius:10px;background:var(--surface-2)}\n.mk-histbox>summary{\ndisplay:flex;align-items:center;gap:9px;cursor:pointer;list-style:none;\npadding:10px 13px;font-weight:600;font-size:clamp(16px,0.08375vw + 14.856px,17px);\ncolor:var(--text-1);border-radius:10px;user-select:none}\n.mk-histbox>summary::-webkit-details-marker{display:none}\n.mk-histbox>summary::before{\ncontent:'';width:.42em;height:.42em;flex:0 0 auto;margin-left:2px;\nborder-right:2px solid var(--muted);border-bottom:2px solid var(--muted);\ntransform:rotate(-45deg);transition:transform .14s ease}\n.mk-histbox[open]>summary::before{transform:rotate(45deg)}\n.mk-histbox>summary:hover{background:var(--surface-3)}\n.mk-histbox>summary .n{\nfont-weight:600;font-variant-numeric:tabular-nums;color:var(--muted);\nfont-size:clamp(15px,0.08375vw + 13.856px,16px);\nbackground:var(--surface-3);border-radius:999px;padding:1px 9px}\n.mk-histbox>summary .g{flex:1}\n.mk-histbox>summary:focus-visible{outline:2px solid var(--brand);outline-offset:-2px}\n.mk-histbox .mk-hist{padding:11px 13px 13px;background:var(--surface-1);\nborder-top:1px solid var(--border);border-radius:0 0 9px 9px}\n@media (prefers-reduced-motion:reduce){.mk-histbox>summary::before{transition:none}}\n.mk-hist{display:flex;flex-direction:column;gap:8px}\n.mk-hist .h{display:flex;gap:9px;align-items:flex-start;font-size:clamp(16px,0.08375vw + 14.856px,17px);color:var(--text-2)}\n.mk-hist .h b{color:var(--text-1);font-weight:600}\n.mk-hist .h .when{color:var(--muted);font-size:clamp(14px,0.08375vw + 12.856px,15px)}\n.mk-hist .h.rej{background:var(--crit-wash);color:var(--critical-ink);padding:8px 10px;border-radius:8px}\n.mk-hist .h.rej b{color:var(--critical-ink)}\n.mk-hist .h.rej .when{color:var(--critical-ink)}\n.mk-step-edit{display:flex;flex-wrap:wrap;align-items:center;gap:7px 8px;padding:8px 10px;border:1px solid var(--border);border-radius:9px;background:var(--surface-2);margin-bottom:6px}\n.mk-step-edit .st{flex:1 1 16em;min-width:10ch;font-size:clamp(16px,0.08375vw + 14.856px,17px);overflow-wrap:normal;word-break:normal;hyphens:none;cursor:pointer;text-align:left;font-family:inherit;padding:0;line-height:1.35}\n.mk-step-edit button.st:hover{color:var(--brand-ink)}\n.mk-step-edit .sx-group{display:inline-flex;gap:2px;flex:0 0 auto}\n.mk-step-edit .fase{font-family:inherit}\n.mk-step-edit.done .st{text-decoration:line-through;color:var(--muted)}\n.mk-step-edit input[type=date]{border:1px solid var(--border);border-radius:6px;padding:3px 6px;background:var(--surface-1);color:var(--text-1);font-size:clamp(15px,0.08375vw + 13.856px,16px);flex:0 0 auto;width:auto;min-width:8.5em}\n.mk-step-edit select{border:1px solid var(--border);border-radius:6px;padding:3px 6px;background:var(--surface-1);color:var(--text-1);font-size:clamp(15px,0.08375vw + 13.856px,16px);max-width:9em;flex:0 0 auto}\n.mk-step-edit .sx{cursor:pointer;color:var(--muted);font-size:clamp(17px,0.1675vw + 14.712px,19px);padding:2px 5px;border-radius:5px;min-width:24px;font-family:inherit}\n.mk-step-edit .sx:hover{background:var(--surface-3);color:var(--text-1)}\n.mk-step-edit .fase{font-size:clamp(14px,0.08375vw + 12.856px,15px);font-weight:600;letter-spacing:.3px;padding:1px 6px;border-radius:4px;background:var(--surface-3);color:var(--muted);text-transform:uppercase}\n.mk-step-edit .fase.pos{background:var(--good-wash);color:var(--good-ink)}\n.mk-rejbox{background:var(--crit-wash);border:1px solid var(--critical);color:var(--critical-ink);border-radius:10px;padding:10px 12px;font-size:clamp(16px,0.08375vw + 14.856px,17px);display:flex;gap:8px;align-items:flex-start}\n.mk-rejbox b{font-weight:600}\n.mk-rejbox .x{margin-left:auto;cursor:pointer;font-weight:600;flex:0 0 auto}\n.mk-list .li{cursor:pointer;border-radius:8px;padding:10px 8px;width:100%;text-align:left;font:inherit}\n.mk-list .li .t{display:flex;flex-direction:column}\n.mk-list .li .tt,.mk-list .li .ts{display:block}\n.mk-list .li:hover{background:var(--surface-2)}\n.mk-tabs{display:flex;gap:4px;background:var(--surface-3);border-radius:10px;padding:3px;margin-bottom:4px}\n.mk-tabs button{flex:1;padding:8px;border-radius:8px;font-weight:600;font-size:clamp(16px,0.08375vw + 14.856px,17px);color:var(--text-2)}\n.mk-tabs button.active{background:var(--surface-1);color:var(--text-1);box-shadow:0 1px 2px rgba(0,0,0,.08)}\n.mk-cfg-row{display:flex;align-items:center;gap:10px;padding:9px 6px;border-bottom:1px solid var(--border-2);min-width:0;width:100%;text-align:left;font:inherit}\nbutton.mk-cfg-row{cursor:pointer;border-radius:8px}button.mk-cfg-row:hover{background:var(--surface-2)}\n.mk-cfg-row:last-child{border-bottom:none}\n.mk-cfg-row .nm{flex:1;min-width:0;font-weight:600;font-size:clamp(16px,0.08375vw + 14.856px,17px);overflow-wrap:anywhere}\n.mk-cfg-row .nm small{display:block;color:var(--muted);font-weight:400;font-size:clamp(15px,0.08375vw + 13.856px,16px)}\n.mk-cfg-row .swatch{width:16px;height:16px;border-radius:5px;flex:0 0 auto;border:1px solid var(--border)}\n.mk-cfg-row .icon-btn{flex:0 0 auto}\n.mk-sug{display:flex;align-items:center;gap:10px;padding:8px 10px;border:1px dashed var(--border);border-radius:9px;margin-bottom:6px;font-size:clamp(16px,0.08375vw + 14.856px,17px);width:100%;text-align:left;font-family:inherit}\nbutton.mk-sug{cursor:pointer}button.mk-sug:hover{border-color:var(--brand);background:var(--brand-wash)}\n.mk-sug .nm{flex:1;min-width:0}\n.mk-sug .nm small{color:var(--muted);font-size:clamp(14px,0.08375vw + 12.856px,15px);margin-left:6px}\n.mk-colorpick{display:flex;gap:6px;flex-wrap:wrap}\n.mk-colorpick button{width:24px;height:24px;border-radius:7px;cursor:pointer;border:2px solid transparent;padding:0}\n.mk-colorpick button.on{border-color:var(--text-1)}\n.mk-daypick{display:flex;gap:5px;flex-wrap:wrap}\n.mk-daypick .wkchip.on{background:var(--brand-wash);border-color:var(--brand);color:var(--brand-ink);font-weight:600}\n.mk-dayhead{display:flex;align-items:center;gap:10px;flex-wrap:wrap}\n.mk-dayhead h3{font-size:clamp(20px,0.08375vw + 18.856px,21px);font-weight:600}\n.mk-empty{font-size:clamp(16px,0.08375vw + 14.856px,17px);color:var(--muted);padding:16px;text-align:center;border:1px dashed var(--border);border-radius:10px}\n.note-warn{font-size:clamp(15px,0.08375vw + 13.856px,16px);color:var(--warn-ink);background:var(--warn-wash);padding:9px 12px;border-radius:8px}\n.mk-mini{display:flex;flex-direction:column;gap:8px}\n.mk-mini .row{display:flex;align-items:center;gap:10px;font-size:clamp(16px,0.08375vw + 14.856px,17px);padding:8px 0;border-bottom:1px solid var(--border-2);cursor:pointer;width:100%;text-align:left;font-family:inherit;min-width:0;flex-wrap:wrap}\n.mk-mini .row>.dt{flex:0 0 auto;font-variant-numeric:tabular-nums}\n.mk-mini .row>.tt,.mk-mini .row>span:not(.dt){min-width:0;overflow:hidden;text-overflow:ellipsis}\n.mk-mini .row:last-child{border-bottom:none}\n.mk-mini .row:hover{color:var(--brand-ink)}\n.mk-mini .row .dt{font-weight:600;font-variant-numeric:tabular-nums;color:var(--text-2);width:auto;min-width:4.6em;flex:0 0 auto;white-space:nowrap}\n.mk-mini .row .tt{flex:1;min-width:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;font-weight:600}\n.mk-mini-kpis{display:flex;gap:8px;flex-wrap:wrap;margin-bottom:4px}\n.mk-mini-kpis button{font-size:clamp(15px,0.08375vw + 13.856px,16px);font-weight:600;padding:3px 9px;border-radius:20px;background:var(--surface-3);color:var(--text-2);display:inline-flex;align-items:center;gap:5px;cursor:pointer;font-family:inherit}\n.mk-mini-kpis button:hover{background:var(--brand-wash);color:var(--brand-ink)}\n#mTitle:focus{outline:none}\n@media (max-width:1200px){\n.mk-rot{display:flex;overflow-x:auto;gap:8px;padding-bottom:6px}\n.mk-rot-col{min-width:17em;flex:0 0 17em;max-width:86vw}\n.mk-kpis{grid-template-columns:repeat(3,minmax(0,1fr))}\n.mk-kanban{grid-template-columns:repeat(3,minmax(0,1fr))}\n.mk-cfg{grid-template-columns:1fr}\n}\n@media (max-width:900px){\n.mk-kanban{grid-template-columns:repeat(2,minmax(0,1fr))}\n.mk-mgrid{grid-template-columns:1fr}\n.mk-mgrid .colA,.mk-mgrid .colB,.mk-mgrid .colC{grid-column:1;grid-row:auto}\n}\n@media (max-width:760px){\n.mk-kpis{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}\n.mk-kpi{padding:11px 12px}.mk-kpi .k-val{font-size:clamp(25px,0.1675vw + 22.712px,27px)}\n.mk-kanban{display:flex;overflow-x:auto;scroll-snap-type:x mandatory;gap:10px;padding-bottom:8px}\n.mk-kanban .kcol{flex:0 0 84%;scroll-snap-align:center}\n.mk-cal{overflow-x:auto;overscroll-behavior-x:contain}\n.mk-cal-head,.mk-cal-grid{min-width:672px;grid-template-columns:repeat(7,1fr);overflow-x:visible}\n.mk-cell{min-height:84px}\n.mk-cron{grid-template-columns:1fr}\n.mk-alerts{grid-template-columns:1fr}\n.mk-monthbar .mk-mnav h2{min-width:130px;font-size:clamp(17px,0.1675vw + 14.712px,19px)}\n.mk-datebox{grid-template-columns:1fr}\n.mk-mhead{display:grid;grid-template-columns:auto minmax(0,1fr) auto;align-items:center;gap:8px 10px}\n.mk-mhead .mk-num{grid-column:1}.mk-mhead h3{grid-column:2}.mk-mhead .icon-btn{grid-column:3}.mk-mhead .tag{grid-column:2;grid-row:2;justify-self:start}\n.mk-step-edit{flex-wrap:wrap}\n.mk-step-edit .st{flex:1 1 100%}\n.mk-step-edit select{flex:1 1 120px;max-width:none}\n.mk-step-edit .sx-group{margin-left:auto}\n}\n:root[data-theme=\"rosa\"]{\n--surface-1:#ffffff; --surface-2:#fff6f9; --surface-3:#fbe9f0;\n--page:#f8dfe9;\n--text-1:#2a1420; --text-2:#5c3f4d; --muted:#7c5e6c;\n--grid:#f0d3de; --border:rgba(160,40,90,.16); --border-2:rgba(160,40,90,.09);\n--brand:#de2280; --brand-d:#c42577; --brand-wash:#fde0ec;\n--good:#0a8a0a; --warning:#e0920a; --serious:#ec835a; --critical:#d03b3b;\n--good-wash:#e7f6e7; --warn-wash:#fdf1dc; --serious-wash:#fdeee7; --crit-wash:#fbe8e8;\n--brand-ink:#c21d6f; --good-ink:#097809; --warn-ink:#8d5c06; --serious-ink:#b44115; --critical-ink:#c12e2e;\n--purple-ink:#5a45c9; --purple-wash:#ece9fb; --marca-ouro:#8a5a3c;\n--shadow:0 1px 2px rgba(120,30,70,.06),0 4px 16px rgba(120,30,70,.10);\n}\n:root[data-theme=\"rosa\"] .topbar h1,:root[data-theme=\"rosa\"] .section-title h2{color:var(--brand-ink)}\n:root[data-theme=\"rosa\"] .topbar{background:var(--surface-2)}\n:root[data-theme=\"rosa\"] .brand .logo{background:linear-gradient(135deg,var(--brand),#8e2a6a)}\n:root[data-theme=\"rosa\"] .mk-date{background:#c2185b;color:#fff}\n:root[data-theme=\"rosa\"] .mk-date.promo{background:#b45309;color:#fff}\n:root[data-theme=\"rosa\"] .mk-al-days.comem{background:#c2185b;color:#fff}\n:root[data-theme=\"rosa\"] .mk-al-days.promo{background:#b45309;color:#fff}\n:root[data-theme=\"rosa\"] .mk-cell.wknd:not(.out){background:#fff2f7}\nbody[data-route=\"marketing\"] :focus-visible,#modal :focus-visible{outline:2px solid var(--brand);outline-offset:2px}\n.mk-toque-hint{display:none}\n@media (max-width:760px){.mk-drag-hint{display:none}.mk-toque-hint{display:inline}}\nbody[data-route=\"marketing\"] .mk-rot-item.somente-leitura{cursor:default}\nbody[data-route=\"marketing\"] .mk-rot-item.somente-leitura:hover{background:transparent;border-color:var(--border)}\nbody[data-route=\"marketing\"] input.mk-ren,#modal input.mk-ren{flex:1;min-width:0;font:inherit;font-size:clamp(16px,0.08375vw + 14.856px,17px);padding:5px 8px;border:1px solid var(--brand);border-radius:7px;background:var(--surface-1);color:var(--text-1)}\nbody .mk-mini-kpis .mk-mini-lab{font-size:clamp(16px,0.08375vw + 14.856px,17px);color:var(--muted);font-weight:600;align-self:center;margin-right:2px}\n@media (min-width:761px) and (max-width:1200px){\nbody[data-route=\"marketing\"] .mk-ev .tt{white-space:normal;overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;line-height:1.25}\nbody[data-route=\"marketing\"] .mk-cell{min-height:clamp(120px,0.5863vw + 111.99px,127px)}\n}\n#modal #mTitle:focus,#modal #mTitle:focus-visible{outline:none}\n.mk-toast{transition:bottom .18s ease}\nbody[data-route=\"marketing\"] .section-title{\ndisplay:flex;flex-wrap:wrap;align-items:center;justify-content:center;\ngap:8px 12px;margin:30px 0 16px;text-align:center}\nbody[data-route=\"marketing\"] .section-title h2{flex:1 1 100%}\nbody[data-route=\"marketing\"] .section-title .st-sub{flex:1 1 100%;order:1;margin-top:-4px}\nbody[data-route=\"marketing\"] .mk-section:first-child .section-title,\nbody[data-route=\"marketing\"] .content>*:first-child .section-title{margin-top:6px}\nbody[data-route=\"marketing\"] .section-title h2{\ndisplay:flex;align-items:center;justify-content:center;gap:.26em;\nwidth:100%;font-size:clamp(34px,3.35vw + -11.76px,74px);\nline-height:1.1;letter-spacing:-.02em;font-weight:400;margin-bottom:2px}\nbody[data-route=\"marketing\"] .section-title h2::before,\nbody[data-route=\"marketing\"] .section-title h2::after{\ncontent:'';flex:1 1 auto;max-width:2.7em;height:1px;\nbackground:linear-gradient(90deg,transparent,var(--brand-ink),transparent);opacity:.42}\nbody[data-route=\"marketing\"] .section-title h2 .orn{\nflex:0 0 auto;width:.2em;height:.2em;border-radius:2px;\nbackground:var(--brand-ink);opacity:.55;transform:rotate(45deg)}\nbody[data-route=\"marketing\"] .section-title .grow{display:none}\nbody[data-route=\"marketing\"] .section-title>*:not(h2){order:2}\nbody[data-route=\"marketing\"] .section-title .mk-legend{justify-content:center}\n@media (max-width:760px){\nbody[data-route=\"marketing\"] .section-title{margin:22px 0 12px}\nbody[data-route=\"marketing\"] .section-title h2::before,\nbody[data-route=\"marketing\"] .section-title h2::after{max-width:26px}\n}\n@media (max-width:560px){\nbody[data-route=\"marketing\"] .section-title h2{font-size:26px;letter-spacing:-.01em}\n}</style>");
  ...
  const ESTAGIOS = [
    /* Os nomes seguem todos a mesma forma: um ESTADO em que a peça está, sem
       misturar substantivo ("Ideia") com particípio ("Aprovadas"). O id no banco
       não muda -- 'ideia', 'prod', 'rev', 'aprov' e 'pub' continuam iguais, e a
       trigger e a RLS não sabem que o rótulo mudou. */
    { id: 'ideia', label: 'A fazer', cor: '#898781', desc: 'Pauta ainda sem produção. Entra no calendário se tiver data-alvo.' },
    { id: 'prod', label: 'Produzindo', cor: '#e0920a', desc: 'Peça sendo feita. Aparece no cronograma de produção.' },
    { id: 'rev', label: 'Em revisão', cor: '#ec835a', desc: 'Esperando o gerente aprovar ou reprovar.' },
    { id: 'aprov', label: 'Para publicar', cor: '#2976d4', desc: 'Já aprovada pelo gerente e agendada. Falta ir ao ar.' },
    { id: 'pub', label: 'Concluído', cor: '#0a8a0a', desc: 'Já está no ar. Recebe a data de conclusão automaticamente.' }
  ];
  const estagio = id => ESTAGIOS.find(s => s.id === id) || ESTAGIOS[0];
  /* Atrasado nao e um estagio: e uma condicao que se sobrepoe a qualquer um
     deles. Mesmo assim usa a mesma forma dos outros rotulos, para a tela nao
     misturar "Produzindo" com "Atrasadas" na mesma fileira. */
  ...
  function icone(id, cls) {
    ...
    /* Quem le a lista tem que saber o que o visto verde quer dizer -- e quem
       usa leitor de tela tambem, por isso entra no aria-label e nao so no title. */
    const jaFoi = /\bok\b/.test(cls || '');
    const rotulo = c.nome + (jaFoi ? ' — já foi ao ar' : '');
    return '<span class="ci ' + (cls || '') + '" style="background:' + c.cor + ';--tinta:' + tintaSobre(c.cor) + '" title="' + esc(rotulo) + '" aria-label="' + esc(rotulo) + '">' + dentro + (c.badge ? '<span class="bd">' + esc(c.badge) + '</span>' : '') + '</span>';
  }
  ...
  const tagEstagio = p => { const s = estagio(p.stage), ov = atrasada(p); return '<span class="tag" style="' + (ov ? 'background:var(--crit-wash);color:var(--critical-ink)' : corSuave(s.cor)) + '"><span class="dot" style="background:' + (ov ? 'var(--critical)' : s.cor) + '"></span>' + (ov ? ATRASADO : s.label) + '</span>'; };
  ...
  async function carregar() {
    ...
    const canaisPorPeca = {}, feitosPorPeca = {};
    (pcc.data || []).forEach(r => {
      (canaisPorPeca[r.peca_id] = canaisPorPeca[r.peca_id] || []).push(r.canal_id);
      if (r.feito) (feitosPorPeca[r.peca_id] = feitosPorPeca[r.peca_id] || []).push(r.canal_id);
    });
    ...
    M.pecas = (pc.data || []).map(r => ({
      ...
      canais: canaisPorPeca[r.id] || [], canaisFeitos: feitosPorPeca[r.id] || [],
      etapas: etapasPorPeca[r.id] || [], links: linksPorPeca[r.id] || []
    }));
  ...
  async function recarregar() {
    ...
    if (c && c.p) {
      ...
      if (fresca) {
        const anterior = c.p, x = c.rascunho;
        ['stage', 'prodStart', 'concl', 'pubReal', 'reprov', 'num', 'id'].forEach(k => { x[k] = fresca[k]; });
        /* Junção de três pontas. O modal guarda um retrato de quando abriu; ações
           que gravam na hora (o ✓ da etapa, o tique do canal, confirmar a
           publicação) trocam esse retrato pelo do banco. Sem esta parte, o campo
           que a pessoa NÃO tocou continuaria com o valor velho no rascunho e o
           Salvar seguinte escreveria ele por cima do que outra pessoa gravou.
           Regra: campo que o rascunho não mudou passa a valer o do banco; campo
           que ela editou fica com a edição dela. */
        CAMPOS.forEach(k => {
          if (k === 'etapas' || k === 'canaisFeitos') return;   // tratados abaixo
          if (JSON.stringify(x[k]) === JSON.stringify(anterior[k]))
            x[k] = JSON.parse(JSON.stringify(fresca[k] === undefined ? null : fresca[k]));
        });
        x.etapas.forEach(e => {
          const f = fresca.etapas.find(y => y.id === e.id);
          if (f) { e.done = f.done; e.doneBy = f.doneBy; e.doneAt = f.doneAt; }
        });
        /* o tique de canal grava na hora: o rascunho copia do banco, limitado aos
           canais que o rascunho ainda tem escolhidos */
        x.canaisFeitos = (fresca.canaisFeitos || []).filter(id => x.canais.includes(id));
        c.p = fresca;
      } else { c.p = null; }
    }
    ...
    return '<div class="mk-alerts">' + prox.map(d => {
      ...
      return '<button class="mk-alert ' + (n === 0 ? 'hoje' : '') + '" onclick="MK.abrirData(\'' + d.id + '\')">' +
        ...
        (lig.length ? lig.length + ' peça' + (lig.length > 1 ? 's' : '') + ' ligada' + (lig.length > 1 ? 's' : '') +
          (pend ? ' · <b>' + pend + ' antes de "' + estagio('aprov').label + '"</b>' : '') +
  ...
  function indicadoresHtml(lista) {
    ...
    /* O nome do indicador vem do MESMO lugar que o nome da etapa (ESTAGIOS).
       Antes eram dois textos soltos: renomear um e esquecer o outro era o jeito
       mais facil de a tela ficar dizendo duas coisas para o mesmo estado. */
    const nome = id => estagio(id).label;
    return '<div class="mk-kpis">' +
      t(nome('ideia'), ideias.length, [semData ? semData + ' sem data' : '', venc ? '<b>' + venc + ' vencida' + (venc > 1 ? 's' : '') + '</b>' : ''].filter(Boolean).join(' · ') || 'todas com data', estagio('ideia').cor, 0, "MK.lista('ideia')") +
      t(nome('prod'), prod.length, rej ? '<b>' + rej + ' reprovada' + (rej > 1 ? 's' : '') + '</b>' : (totalProd > prod.length ? totalProd + ' no total' : 'nenhuma reprovada'), estagio('prod').cor, 0, "MK.lista('prod')",
        nome('prod') + ' com publicação em ' + mesNome(mesCal.m) + ': ' + prod.length + '. ' + nome('prod') + ' ao todo, contando os outros meses: ' + totalProd + '. O cronograma abaixo mostra as ' + totalProd + '.') +
      t(nome('rev'), rev.length, meu ? '<b>' + meu + ' esperando você</b>' : 'aguardando gerente', estagio('rev').cor, 0, "MK.lista('rev')") +
      t(nome('aprov'), aprov.length, hj ? hj + ' vai ao ar hoje' : 'agendadas', estagio('aprov').cor, 0, "MK.lista('aprov')") +
      t(nome('pub'), pub.length, (pub.filter(p => !p.pubReal && !p.pub).length ? pub.filter(p => !p.pubReal && !p.pub).length + ' sem data' : 'no mês'), estagio('pub').cor, 0, "MK.lista('pub')",
        'Peças concluídas com data em ' + mesNome(mesCal.m) + ' (a data real, ou a planejada quando não há real).') +
      /* O rodapé dizia "1 ainda não aprovada" e a lista que abre se chama "a data de
         publicação passou" -- duas coisas diferentes no mesmo cartão. Agora os dois
         falam de atraso, e o detalhe diz onde a peça travou. */
      t(ATRASADO, late.length, late.length ? [lateA ? lateA + ' esperando confirmação' : '', lateP ? lateP + ' antes de "' + estagio('aprov').label + '"' : ''].filter(Boolean).join(' · ') : 'tudo em dia', '#d03b3b', late.length > 0, "MK.lista('late')", 'A data de publicação já passou e a peça não foi concluída.') +
      '</div>';
  }
  ...
  function calendarioHtml() {
    ...
    const legenda = ESTAGIOS.map(s => '<button class="lg ' + (escondidos.has(s.id) ? 'off' : '') + '" onclick="MK.alternarEstagio(\'' + s.id + '\')" title="' + (escondidos.has(s.id) ? 'Escondido — clique para mostrar' : 'Clique para esconder este estágio do calendário') + '"><i class="dot ' + (s.id === 'ideia' ? 'dash' : '') + '" style="' + (s.id === 'ideia' ? '' : 'background:' + s.cor) + '"></i>' + s.label + '</button>').join('') +
      '<span class="lg" title="Data de publicação passou sem publicar"><i class="dot" style="background:#d03b3b"></i>' + ATRASADO + '</span>' +
      /* O visto verde no logo do canal era o único sinal da tela sem legenda -- e no
         celular não existe passar o mouse para descobrir o que ele quer dizer. */
      '<span class="lg mk-lg-ok"><i class="vst" aria-hidden="true">\u2713</i>já foi ao ar nesse canal</span>';
    const cel = c => {
    ...
    return '<div class="mk-section"><div class="section-title" title="' + (podeEditar() ? 'Clique num dia para ver tudo dele. Arraste uma peça para mudar a data.' : 'Clique num dia para ver tudo dele.') + '"><h2><i class="orn" aria-hidden="true"></i>Calendário de publicações<i class="orn" aria-hidden="true"></i></h2><span class="st-sub mk-cal-hint">deslize para o lado para ver a semana inteira</span><div class="grow"></div><div class="mk-legend">' + legenda + '</div>' +
      '<button class="fchip ' + (verInicio ? 'on' : '') + '" onclick="MK.verInicio()">Ver início de produção</button>' +
      (semData || venc ? '<button class="fchip" onclick="MK.lista(\'semdata\')">' + (semData ? semData + ' em "' + estagio('ideia').label + '" sem data' : '') + (semData && venc ? ' · ' : '') + (venc ? venc + ' com data vencida' : '') + '</button>' : '') + '</div>' +
  ...
  function cardHtml(p) {
    ...
    else if (late) faixa = '<div class="mk-late">' + ATRASADO + ' · era ' + dm(p.pub) + '</div>';
    ...
    return '<div class="mk-card" draggable="' + podeEditar() + '" data-num="' + p.num + '" onclick="MK.abrirPeca(' + p.num + ')" role="button" tabindex="0" onkeydown="if(event.key===\'Enter\')MK.abrirPeca(' + p.num + ')">' + faixa +
      ...
      '<div class="mk-chan">' + (p.canais.length ? p.canais.map(c => icone(c, (p.canaisFeitos || []).includes(c) ? 'ok' : '')).join('') : '<span class="mk-pill" style="color:var(--critical-ink);background:var(--crit-wash)">sem canal</span>') + '</div>' +
  ...
  function pipelineHtml(lista) {
    return '<div class="mk-section"><div class="section-title" title="' + (podeEditar() ? 'Em que pé está cada peça. Arraste entre colunas; os contadores são clicáveis.' : 'Em que pé está cada peça. Os contadores são clicáveis.') + '"><h2><i class="orn" aria-hidden="true"></i>Pipeline<i class="orn" aria-hidden="true"></i></h2>' + (podeEditar() ? '<span class="st-sub mk-toque-hint">no celular, abra a peça e mude a etapa por lá</span>' : '') + '<div class="grow"></div>' +
      ...
      ESTAGIOS.map(s => {
        ...
        return '<div class="kcol" style="--sc:' + s.cor + '" data-stage="' + s.id + '"><h3><span class="dot" style="background:' + s.cor + '"></span>' + s.label +
          ...
          (itens.length ? itens.map(cardHtml).join('') : '<div class="kempty">' + (s.id === 'ideia' ? 'Nada aqui ainda' : 'Nada aqui') + '</div>') +
          (s.id === 'ideia' && podeEditar() ? '<button class="mk-newcard" onclick="MK.abrirPeca(null)">＋ Nova peça</button>' : '') + '</div>';
      }).join('') + '</div></div>';
  }
  ...
  function cronogramaHtml() {
    ...
    return '<div class="mk-section"><div class="section-title" title="O que está em produção agora — ao mudar de coluna a peça sai daqui."><h2><i class="orn" aria-hidden="true"></i>Cronograma de produção<i class="orn" aria-hidden="true"></i></h2><div class="grow"></div>' +
  ...
  function rotinaHtml() {
    ...
    return '<div class="mk-section"><div class="section-title" title="Rotina do time. Zera toda segunda e guarda o histórico."><h2><i class="orn" aria-hidden="true"></i>Rotina de marketing<i class="orn" aria-hidden="true"></i></h2><span class="st-sub mk-rot-hint">deslize para o lado para ver os outros dias</span><div class="grow"></div>' +
  ...
  function cadastrosHtml() {
    return '<div class="mk-section"><div class="section-title" title="Categorias com modelo de etapas, canais e datas."><h2><i class="orn" aria-hidden="true"></i>Cadastros<i class="orn" aria-hidden="true"></i></h2></div><div class="mk-cfg">' +
  ...
  function cartaoPainel() {
    ...
    return '<div class="chartrow cr-bottom" style="margin-top:16px;order:6"><div class="card pad"><div class="section-title" title="O que vai ao ar nos próximos 7 dias."><h2>📣 Marketing</h2><span class="st-sub">o que vai ao ar nos próximos 7 dias</span><div class="grow"></div><button class="btn ghost sm" onclick="go(\'marketing\')">Abrir aba</button></div>' +
      '<div class="mk-mini-kpis"><span class="mk-mini-lab">no total, de todos os meses:</span><button onclick="go(\'marketing\');MK.lista(\'prod-todas\')"><i class="dot" style="background:' + estagio('prod').cor + '"></i>' + prod + ' em "' + estagio('prod').label + '"</button>' +
      '<button onclick="go(\'marketing\');MK.lista(\'rev\')"><i class="dot" style="background:' + estagio('rev').cor + '"></i>' + rev + ' em "' + estagio('rev').label + '"</button>' +
      (hj ? '<button onclick="go(\'marketing\');MK.lista(\'hoje\')"><i class="dot" style="background:' + estagio('aprov').cor + '"></i>' + hj + ' vai ao ar hoje</button>' : '') +
      (late ? '<button style="color:var(--critical-ink)" onclick="go(\'marketing\');MK.lista(\'late\')"><i class="dot" style="background:#d03b3b"></i>' + late + ' ' + ATRASADO.toLowerCase() + (late > 1 ? 's' : '') + '</button>' : '') + '</div>' +
      '<div class="mk-mini">' + (semana.length ? semana.map(p => '<button class="row" onclick="go(\'marketing\');MK.abrirPeca(' + p.num + ')"><span class="dt">' + dm(p.pub) + '</span>' + tagEstagio(p) + '<span class="tt">#' + p.num + ' ' + esc(p.title) + '</span><span class="mk-chan">' + p.canais.slice(0, 3).map(c => icone(c, (p.canaisFeitos || []).includes(c) ? 'ok' : '')).join('') + '</span></button>').join('') : '<div class="mk-empty">Nada agendado para os próximos 7 dias.</div>') + '</div></div>' +
  ...
  /* O campo do briefing tinha altura fixa de tres linhas: um briefing de 318
     caracteres cortava a primeira linha e obrigava a rolar DENTRO da caixinha --
     com 350px de coluna vazia logo abaixo dela. Agora ele cresce com o texto, com
     teto de 45% da tela para nao empurrar o resto do card para fora. */
  function crescerBrief(el) {
    if (!el) return;
    el.style.height = 'auto';
    el.style.height = Math.min(el.scrollHeight + 2, Math.round(innerHeight * 0.45)) + 'px';
  }
  function marcarMeu() {
    const m = $('#modal'); if (!m) return;
    if (!m.querySelector('i[data-mkt]')) m.insertAdjacentHTML('beforeend', '<i data-mkt hidden></i>');
    crescerBrief(m.querySelector('#f_desc'));
  }
  ...
  /* O histórico entra RECOLHIDO: ele cresce sem parar e empurrava para baixo tudo
     que a pessoa veio fazer. Mas a escolha DELA é lembrada -- quem gosta de
     trabalhar com o histórico aberto não pode ter que clicar de novo em cada peça
     que abre, e quem abre trinta peças por dia sentiria isso trinta vezes.
     Fica no navegador, por pessoa, porque não é dado da peça. */
  const CHAVE_HIST = 'mkt-hist-aberto';
  let histOpen = (() => { try { return localStorage.getItem(CHAVE_HIST) === '1'; } catch (e) { return false; } })();
  function marcarHist(v) { histOpen = !!v; try { localStorage.setItem(CHAVE_HIST, histOpen ? '1' : '0'); } catch (e) {} }
  ...
  async function abrirPeca(num, dataPreset, dataIdPreset) {
    ...
    const rascunho = p ? clone(p) : {
      id: null, num: null, title: '', desc: '', cat: catPadrao ? catPadrao.id : null, canais: [], canaisFeitos: [], stage: 'ideia',
    ...
    const monta = () => {
      ...
      const linhaEtapa = e => '<div class="mk-step-edit ' + (e.done ? 'done' : '') + '">' +
        ...
        (ed ? '<select onchange="MK.etapaRascunho(\'' + e.id + '\',\'resp\',this.value)" aria-label="Responsável da etapa"><option value="">quem?</option>' + opts(e.resp, ehMkt) + '</select>' +
          ...
          : (e.resp ? avatar(e.resp, 'xs') : '') + '<span class="sd" style="font-size:clamp(14px,0.08375vw + 12.856px,15px);color:var(--muted)">' + (e.date ? dm(e.date) : '') + '</span>') + '</div>';
      /* so da para marcar o tique de um canal que ja existe no banco */
      const jaSalvo = id => !!(ctx.p && ctx.p.canais.includes(id));
      ...
      return '<div class="mk-mhead">' + (novo ? '<span class="mk-num" title="O número sai do banco ao salvar — nunca repete">#—</span>' : '<span class="mk-num">#' + x.num + '</span>') +
        ...
        '<div class="mk-mgrid"><div class="col colA">' +
        ...
        '<div class="field"><label for="f_desc">Descrição / briefing</label><textarea id="f_desc" rows="3" maxlength="2000" oninput="MK.crescerBrief(this)" placeholder="Ângulo, o que mostrar, o que não pode faltar" ' + (ed ? '' : 'disabled') + '>' + esc(x.desc) + '</textarea></div>' +
        ...
        (novo || !x.canais.length ? '' : '<div class="field"><label>Já foi ao ar em <span style="font-weight:500;color:var(--muted)">— '
          + x.canaisFeitos.filter(id => x.canais.includes(id)).length + ' de ' + x.canais.length
          + (ed ? ' · grava na hora' : '') + '</span></label>'
          + '<div class="mk-feitos" role="group" aria-label="Canais em que a peça já foi ao ar">'
          + x.canais.map(id => { const c = canalDe(id), ok = x.canaisFeitos.includes(id); return '<button class="chip-feito ' + (ok ? 'on' : '') + '" '
            + (ed && jaSalvo(id) ? 'onclick="MK.canalFeito(\'' + id + '\')"' : 'disabled')
            + (ed && !jaSalvo(id) ? ' title="Salve a peça para poder marcar este canal"' : '')
            + ' role="checkbox" aria-checked="' + ok + '">'
            + '<span class="pubchk" aria-hidden="true">' + (ok ? '✓' : '') + '</span>' + icone(id) + '<span class="nm">' + esc(c.nome) + '</span>'
            + '<span class="sr">' + (ok ? ' — já foi ao ar' : ' — ainda não foi ao ar') + '</span></button>'; }).join('')
          + '</div></div>') +
        ...
        (novo ? '' : '<details class="mk-histbox"' + (histOpen ? ' open' : '') + ' ontoggle="MK.marcarHist(this.open)">'
          + '<summary><span class="t">Histórico</span><span class="n">' + ctx.historico.length + '</span>'
          + '<span class="g"></span></summary>'
          + '<div class="mk-hist">' + ctx.historico.slice().reverse().map(h => '<div class="h ' + (h.rej ? 'rej' : '') + '">' + avatar(h.by, 'xs') + '<div><b>' + esc(shortName(h.by)) + '</b> ' + esc(textoHist(h.txt)) + '<div class="when">' + desde(h.at) + '</div></div></div>').join('') + '</div></details>') +
        '</div><div class="col colC"><div class="mk-side">' +
        '<div class="field"><label for="f_stage">Etapa do pipeline</label><select id="f_stage" ' + (ed ? '' : 'disabled') + ' onchange="MK.mudarEstagio(this.value)">' + ESTAGIOS.filter(s => !novo || s.id === 'ideia' || s.id === 'prod').map(s => '<option value="' + s.id + '" ' + (s.id === x.stage ? 'selected' : '') + ' ' + (((s.id === 'aprov' || s.id === 'pub') && !ehAprovador() && x.stage !== 'aprov') ? 'disabled' : '') + '>' + s.label + (((s.id === 'aprov' || s.id === 'pub') && !ehAprovador() && x.stage !== 'aprov') ? ' (só gerente)' : '') + '</option>').join('') + '</select>' + (novo ? '<div class="note-sm" style="margin-top:6px">' + esc('Peça nova nasce em "' + estagio('ideia').label + '" ou já em "' + estagio('prod').label + '". As outras etapas vêm depois, pelo fluxo.') + '</div>' : '') + '</div>' +
        ...
        /* Numa peça NOVA estes três blocos só mostram "—" e um aviso de "aparece
           depois": ocupam espaço sem informar nada. Aparecem quando existirem. */
        (novo ? '' :
        ...
        /* na criacao a pasta ainda nao existe: era so um aviso ocupando espaco */
        (novo ? '' : '<div class="field"><label>Pasta no Drive</label>' + (false ? ''
  ...
  async function salvarPeca() {
    ...
    /* O modal guarda um retrato da peça de quando foi aberto. Mandar o retrato
       inteiro no update apaga o que outra pessoa gravou nesse meio-tempo -- e sem
       deixar rastro, porque o histórico só diz "editou a peça". Por isso o update
       leva SÓ as colunas que realmente mudaram no rascunho: marcar um canal como
       publicado não reescreve título, data nem responsável. */
    const colunas = o => ({
      titulo: cortaBonito(String(o.title || '').trim(), 140), descricao: o.desc || null,
      categoria_id: o.cat, resp_id: o.resp || null, revisor_id: o.revisor || null,
      pub: o.pub || null, data_id: o.dataId || null, drive_url: limpaUrl(o.drive) || null
    });
    const campos = colunas(x);
    ...
    if (!c.p) {
      ...
      const antes = colunas(c.p), sos = {};
      Object.keys(campos).forEach(k => { if (JSON.stringify(campos[k]) !== JSON.stringify(antes[k])) sos[k] = campos[k]; });
      if (Object.keys(sos).length) {
        const r = await sb.from('mkt_pecas').update(sos).eq('id', pecaId);
        if (r.error) { toast('Não deu para salvar: ' + (r.error.message || 'sem permissão'), 1); return; }
        await hist(pecaId, 'editou a peça');
      }
    }
    const antigo = c.p || { canais: [], canaisFeitos: [], etapas: [], links: [] };
    /* canais */
    const rem = antigo.canais.filter(id => !x.canais.includes(id));
    const add = x.canais.filter(id => !antigo.canais.includes(id));
    /* Escrita que falha em silêncio é pior que erro na cara: a pessoa vê "salva."
       e vai embora. Toda gravação de canal responde por si. */
    const falhas = [];
    const grava = async (r, oque) => { if (r && r.error) falhas.push(oque + ': ' + (r.error.message || 'sem permissão')); };
    if (rem.length) await grava(await sb.from('mkt_peca_canais').delete().eq('peca_id', pecaId).in('canal_id', rem), 'tirar canal');
    /* canal recem-incluido nasce como NAO publicado -- quem marca e o tique, que
       grava na hora e nao passa por aqui */
    if (add.length) await grava(await sb.from('mkt_peca_canais').insert(add.map(id => ({ peca_id: pecaId, canal_id: id }))), 'incluir canal');
    if (falhas.length) { toast('Salvou a peça, mas não os canais — ' + falhas[0], 1); }
  ...
  async function mover(num, novo) {
    ...
    if (novo === 'aprov') {
      ...
      if (de === 'pub') { if (!confirm('#' + num + ' está concluída. Voltar para "' + estagio('aprov').label + '"?')) return; jaPerguntouPub = true; }
      else if (de !== 'rev') return toast('Para aprovar, a peça precisa passar pela revisão.', 1);
      else return aprovar(num);
    }
    if (novo === 'pub') {
      if (de !== 'aprov') return toast('Só peça em "' + estagio('aprov').label + '" pode ser concluída.', 1);
      return publicar(num);
    }
    if (novo === 'rev') {
  ...
  function abrirReprovar(num) {
    ...
    abrirModal('<div class="modal-head"><h3 id="mTitle">Reprovar #' + p.num + '</h3><div class="grow"></div><button class="icon-btn" onclick="closeModal()" aria-label="Fechar">✕</button></div>' +
      ...
      '<div class="note-warn">A peça volta para <b>' + esc(estagio('prod').label) + '</b> e ' + esc(primeiroNome(p.resp)) + ' recebe a notificação.</div></div>' +
  ...
  /* Confirmar a publicação é a ação mais definitiva do módulo e era a única sem
     pergunta -- descartar um rascunho perguntava, publicar não. E marcava a peça
     como concluída deixando o checklist em "0 de 1 já foi ao ar": a mesma janela
     dizendo duas coisas contrárias sobre a mesma peça. Agora pergunta, e o que
     ela responde vale para os dois lugares. O caminho contrário continua solto,
     como foi combinado: marcar canal NÃO mexe no estágio. */
  async function publicar(num, jaPerguntou) {
    const p = pecaDe(num); if (!p || !podeEditar()) return;
    if (p.stage !== 'aprov') return toast('Só peça em "' + estagio('aprov').label + '" pode ser concluída.', 1);
    const faltam = p.canais.filter(id => !(p.canaisFeitos || []).includes(id));
    if (!jaPerguntou && !confirm('Confirmar que #' + num + ' foi ao ar hoje (' + dm(hoje()) + ')?'
        + (faltam.length ? '\n\nOs canais ' + faltam.map(id => canalDe(id).nome).join(', ')
            + ' entram como publicados. Dá para desmarcar depois, dentro da peça.' : ''))) return;
    const r = await sb.from('mkt_pecas').update({ stage: 'pub' }).eq('id', p.id);
    if (r.error) return toast(r.error.message || 'sem permissão', 1);
    if (faltam.length) {
      const rc = await sb.from('mkt_peca_canais').update({ feito: true }).eq('peca_id', p.id).in('canal_id', faltam);
      if (rc && rc.error) toast('Peça concluída, mas os canais não foram marcados — ' + (rc.error.message || 'sem permissão'), 1);
    }
    toast('#' + num + ' concluída. Data registrada em ' + dm(hoje()) + '.');
    await recarregar(); atualizarModal();
  }
  ...
  function canal(id) {
    ...
    const i = x.canais.indexOf(id);
    if (i >= 0) {
      x.canais.splice(i, 1);
      /* tirou o canal: o tique de "ja foi ao ar" vai junto. Se ficasse, ele
         reapareceria marcado ao escolher o canal de novo -- dizendo que foi
         publicado num lugar onde ninguem publicou. */
      const j = x.canaisFeitos.indexOf(id); if (j >= 0) x.canaisFeitos.splice(j, 1);
    } else x.canais.push(id);
    atualizarModal();
  }
  /* O checklist: um tique por canal, sem data e sem quem marcou.

     GRAVA NA HORA, igual ao ✓ das etapas. A primeira versão guardava no rascunho
     e só gravava no Salvar -- e a revisora achou o problema: são dois tiques na
     mesma janela, a cinco centímetros um do outro; ninguém lê a linha cinza que
     explica a diferença. Pior no celular, onde o Salvar fica quatro telas abaixo:
     marca o canal, fecha, perde. Agora os dois tiques se comportam igual.

     Canal que ainda não foi salvo não tem linha no banco para marcar; o botão
     dele vem desabilitado, e este guarda é a segunda tranca. */
  async function canalFeito(id) {
    const c = window._pecaCtx, x = rasc();
    if (!x || !podeEditar()) return;
    if (!c || !c.p || !c.p.canais.includes(id)) return toast('Salve a peça primeiro para marcar este canal.', 1);
    sincronizar();
    const novo = !(c.p.canaisFeitos || []).includes(id);
    const r = await sb.from('mkt_peca_canais').update({ feito: novo }).eq('peca_id', c.p.id).eq('canal_id', id);
    if (r.error) return toast(r.error.message || 'sem permissão', 1);
    await recarregar(); atualizarModal();
  }
  ...
  function lista(qual) {
    ...
    if (qual === 'late') return abrirLista(ATRASADO + ' — a data de publicação passou', v.filter(atrasada));
    if (qual === 'semdata') return abrirLista(estagio('ideia').label + ' — sem data ou com data vencida', M.pecas.filter(p => p.stage === 'ideia' && (!p.pub || ideiaVencida(p))));
  ...
  window.MK = {
    ...
    salvarPeca, cancelarPeca, sincronizar, etapaRascunho, canal, canalFeito, marcarHist, crescerBrief, categoria, campo, link, mudarEstagio, mover,
