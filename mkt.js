...
(function () {
  ...
  document.head.insertAdjacentHTML('beforeend', "<style id=\"mkt-style\">.mk-monthbar{display:flex;align-items:center;gap:12px;flex-wrap:wrap;margin-bottom:16px}\n.mk-monthbar .mk-mnav{display:inline-flex;align-items:center;gap:4px;background:var(--surface-1);border:1px solid var(--border);border-radius:10px;padding:3px;box-shadow:var(--shadow)}\n.mk-monthbar .mk-mnav button{width:32px;height:32px;border-radius:8px;display:grid;place-items:center;font-size:15px;color:var(--text-2)}\n.mk-monthbar .mk-mnav button:hover{background:var(--surface-3);color:var(--text-1)}\n.mk-monthbar .mk-mnav h2{font-size:16px;font-weight:750;min-width:170px;text-align:center;letter-spacing:-.2px}\n.mk-monthbar .mk-hint{font-size:12px;color:var(--muted)}\n.mk-monthbar .grow{flex:1}\n.mk-alerts{display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:12px;margin-bottom:18px}\n.mk-alert{display:flex;gap:12px;align-items:center;width:100%;text-align:left;font:inherit;padding:12px 14px;border-radius:var(--radius);background:var(--surface-1);border:1px solid var(--border);box-shadow:var(--shadow);cursor:pointer;transition:.12s;position:relative;overflow:hidden}\n.mk-alert:hover{transform:translateY(-1px);box-shadow:0 2px 4px rgba(11,11,11,.06),0 8px 24px rgba(11,11,11,.09)}\n.mk-alert .mk-al-days{flex:0 0 auto;width:52px;height:52px;border-radius:12px;display:grid;place-items:center;text-align:center;line-height:1;font-weight:800;font-size:20px;letter-spacing:-.5px;font-variant-numeric:tabular-nums}\n.mk-alert .mk-al-days small{display:block;font-size:9.5px;font-weight:700;letter-spacing:.3px;margin-top:3px;opacity:.85}\n.mk-alert .mk-al-info{flex:1;min-width:0;display:flex;flex-direction:column}\n.mk-alert .mk-al-name,.mk-alert .mk-al-sub{display:block}\n.mk-al-days.comem{background:#fbe4ee;color:#b3125c}.mk-al-days.promo{background:#fdf1dc;color:#9a5e00}.mk-al-days.now{background:var(--critical);color:#fff}\n:root[data-theme=\"dark\"] .mk-al-days.comem{background:#3d1229;color:#ff9ccb}:root[data-theme=\"dark\"] .mk-al-days.promo{background:#33280f;color:#fab219}\n@media (prefers-color-scheme: dark){:root:not([data-theme=\"light\"]) .mk-al-days.comem{background:#3d1229;color:#ff9ccb}:root:not([data-theme=\"light\"]) .mk-al-days.promo{background:#33280f;color:#fab219}}\n.mk-al-days svg{width:22px;height:22px}\n.mk-alert .mk-al-name{font-weight:700;font-size:13.5px;line-height:1.3;overflow-wrap:anywhere}\n.mk-alert .mk-al-sub{font-size:11.5px;color:var(--text-2);margin-top:2px;line-height:1.35}\n.mk-alert .mk-al-sub b{color:var(--critical);font-weight:700}\n.mk-alert.hoje{border-color:var(--critical);background:var(--crit-wash)}\n.mk-alert.hoje .mk-al-sub{color:var(--text-1)}\n.mk-kpis{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:12px;margin-bottom:18px}\n.mk-kpi{background:var(--surface-1);border:1px solid var(--border);border-radius:var(--radius);padding:14px 16px;box-shadow:var(--shadow);cursor:pointer;transition:.12s;position:relative;overflow:hidden;text-align:left;min-width:0}\n.mk-kpi:hover{transform:translateY(-1px);box-shadow:0 2px 4px rgba(11,11,11,.06),0 8px 24px rgba(11,11,11,.09)}\n.mk-kpi::before{content:'';position:absolute;left:0;top:0;right:0;height:3px;background:var(--kc,var(--brand))}\n.mk-kpi{font:inherit;display:block;width:100%}\n.mk-kpi .k-label,.mk-kpi .k-val,.mk-kpi .k-foot{display:block}\n.mk-kpi .k-label{color:var(--text-2);font-size:12px;font-weight:650;display:flex;align-items:center;gap:6px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}\n.mk-kpi .k-val{font-size:28px;font-weight:800;letter-spacing:-1px;margin-top:6px;line-height:1;font-variant-numeric:tabular-nums}\n.mk-kpi .k-foot{font-size:11.5px;color:var(--muted);margin-top:7px;font-weight:500;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}\n.mk-kpi .k-foot b{color:var(--critical)}\n.mk-kpi.bad .k-val{color:var(--critical)}\n.mk-section{margin-bottom:22px}\n.mk-section .section-title{margin:4px 0 12px;flex-wrap:wrap;gap:8px 12px}\n.mk-section .section-title h2{font-size:15.5px}\n.mk-section .section-title .st-sub{font-size:12px;color:var(--muted);font-weight:500}\n.mk-legend{display:flex;gap:10px;flex-wrap:wrap;align-items:center}\n.mk-legend .lg{display:inline-flex;align-items:center;gap:5px;font-size:11.5px;color:var(--text-2);font-weight:600;cursor:pointer;padding:3px 8px;border-radius:20px;border:1px solid transparent;font-family:inherit}\n.mk-legend button.lg:hover{background:var(--surface-3);border-color:var(--border)}\n.mk-legend .lg.off{opacity:.5;text-decoration:line-through}\n.mk-legend span.lg{cursor:default}\n.mk-legend .dot{width:9px;height:9px;border-radius:3px}\n.mk-legend .dot.dash{background:transparent;border:1.5px dashed #898781}\n.mk-cal{background:var(--surface-1);border:1px solid var(--border);border-radius:var(--radius);overflow:hidden;box-shadow:var(--shadow)}\n.mk-cal-head{display:grid;grid-template-columns:repeat(7,minmax(0,1fr))}\n.mk-cal-head div{padding:10px 8px;text-align:center;font-size:11px;text-transform:uppercase;letter-spacing:.4px;color:var(--muted);font-weight:700;border-bottom:1px solid var(--border)}\n.mk-cal-head div.wknd{color:var(--brand)}\n.mk-cal-grid{display:grid;grid-template-columns:repeat(7,minmax(0,1fr))}\n.mk-cell{min-height:112px;border-right:1px solid var(--border-2);border-bottom:1px solid var(--border-2);padding:6px 7px;cursor:pointer;transition:background .12s;min-width:0;position:relative}\n.mk-cell:nth-child(7n){border-right:none}\n.mk-cell:hover{background:var(--surface-2)}\n.mk-cell.out{background:var(--surface-2)}\n.mk-cell.out .dn{opacity:.35}\n.mk-cell.out .mk-ev{opacity:.75}\n.mk-cell.wknd:not(.out){background:color-mix(in srgb,var(--brand-wash) 35%,transparent)}\n.mk-cell .dn{font-size:12px;font-weight:700;color:var(--text-2);display:inline-grid;place-items:center;width:22px;height:22px;border-radius:50%}\n.mk-cell.today .dn{background:var(--brand);color:#fff}\n.mk-cell.drag-over{outline:2px dashed var(--brand);outline-offset:-3px;background:var(--brand-wash)}\n.mk-date{display:flex;align-items:flex-start;gap:5px;margin-top:4px;padding:3px 7px;border-radius:6px;background:#fbe4ee;color:#b3125c;font-size:10.5px;font-weight:800;letter-spacing:.2px;line-height:1.25;cursor:pointer}\n.mk-date span{display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;overflow-wrap:anywhere}\n.mk-date svg{margin-top:1px}\n.mk-date.promo{background:#fdf1dc;color:#9a5e00}\n:root[data-theme=\"dark\"] .mk-date{background:#3d1229;color:#ff9ccb}\n:root[data-theme=\"dark\"] .mk-date.promo{background:#33280f;color:#fab219}\n@media (prefers-color-scheme: dark){:root:not([data-theme=\"light\"]) .mk-date{background:#3d1229;color:#ff9ccb}:root:not([data-theme=\"light\"]) .mk-date.promo{background:#33280f;color:#fab219}}\n.mk-date svg{width:11px;height:11px;flex:0 0 auto}\n.mk-ev{display:flex;align-items:center;gap:5px;font-size:10.5px;font-weight:650;padding:3px 7px;border-radius:5px;margin-top:4px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;cursor:grab;border:1px solid transparent;min-width:0}\n.mk-ev:active{cursor:grabbing}\n.mk-ev .n{font-weight:800;font-variant-numeric:tabular-nums;flex:0 0 auto;opacity:.85}\n.mk-ev .tt{overflow:hidden;text-overflow:ellipsis;min-width:0}\n.mk-ev.ideia{border-style:dashed;border-color:#898781;color:var(--text-2);background:transparent}\n.mk-ev.late{background:var(--crit-wash)!important;color:var(--critical)!important;border-color:var(--critical)}\n.mk-ev.hoje{box-shadow:0 0 0 1.5px var(--brand) inset}\n.mk-ev.start{background:transparent;border:1px dotted var(--border);color:var(--muted);font-weight:500}\n.mk-more{font-size:10.5px;color:var(--brand);margin-top:4px;font-weight:700;cursor:pointer}\n.mk-more:hover{text-decoration:underline}\n.mk-kanban{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:12px;align-items:start}\n.mk-kanban .kcol{min-width:0}\n.mk-kanban .kcol{padding:10px;border-top:3px solid var(--sc,var(--border))}\n.mk-kanban .kcol h3{font-size:12.5px}\n.mk-kanban .kcol h3 .count{cursor:pointer;background:var(--surface-3);padding:1px 8px;border-radius:10px;font-size:11px;font-weight:700;margin-left:auto;color:var(--muted);font-family:inherit}\n.mk-kanban .kcol h3 .count:hover{background:var(--brand-wash);color:var(--brand)}\n.mk-kanban .kempty{font-size:12px;color:var(--muted);text-align:center;padding:14px 6px;border:1px dashed var(--border);border-radius:8px}\n.mk-card{background:var(--surface-1);border:1px solid var(--border);border-radius:var(--radius-s);padding:10px 11px;margin-bottom:9px;box-shadow:0 1px 2px rgba(11,11,11,.04);cursor:grab;transition:.12s;position:relative;overflow:hidden}\n.mk-card:hover{border-color:var(--brand);box-shadow:0 2px 8px rgba(11,11,11,.08)}\n.mk-card:active{cursor:grabbing}\n.mk-card.dragging{opacity:.5}\n.mk-card .mk-rej{display:flex;align-items:center;gap:6px;background:var(--critical);color:#fff;font-size:11px;font-weight:800;padding:4px 9px;margin:-10px -11px 9px;letter-spacing:.2px}\n.mk-card .mk-rej span{font-weight:500;min-width:0;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;line-height:1.3}\n.mk-card .mk-rej{align-items:flex-start}\n.mk-card .mk-hoje{display:flex;align-items:center;gap:6px;background:var(--brand);color:#fff;font-size:11px;font-weight:800;padding:4px 9px;margin:-10px -11px 9px}\n.mk-card .mk-late{display:flex;align-items:center;gap:6px;background:var(--crit-wash);color:var(--critical);font-size:11px;font-weight:800;padding:4px 9px;margin:-10px -11px 9px}\n.mk-card .mk-ch{display:flex;align-items:center;justify-content:space-between;gap:6px;margin-bottom:6px}\n.mk-num{font-size:11.5px;font-weight:800;color:var(--text-2);font-variant-numeric:tabular-nums;letter-spacing:.2px;background:var(--surface-3);padding:1px 7px;border-radius:5px;flex:0 0 auto}\n.mk-cat{font-size:10.5px;font-weight:700;padding:2px 8px;border-radius:12px;line-height:1.3;min-width:0;max-width:100%;text-align:right;overflow-wrap:anywhere}\n.mk-card .mk-title{font-weight:650;font-size:13px;line-height:1.35;overflow-wrap:anywhere;margin-bottom:7px}\n.mk-chan{display:flex;gap:4px;flex-wrap:wrap;align-items:center}\n.ci{position:relative}\n.mk-chan .ci{width:20px;height:20px;border-radius:6px;display:grid;place-items:center;flex:0 0 auto}\n.ci .bd{position:absolute;right:-4px;bottom:-4px;background:#fe2c55;color:#fff;font-size:7px;font-weight:900;line-height:1;padding:2px 3px;border-radius:5px;border:1.5px solid var(--surface-1);letter-spacing:.2px}\n.mk-chan .ci svg{width:12px;height:12px;fill:#fff}\n.mk-chan .ci.big{width:26px;height:26px;border-radius:7px}\n.mk-chan .ci.big svg{width:15px;height:15px}\n.mk-chan .ci .lt{color:#fff;font-size:10px;font-weight:900;line-height:1}\n.mk-card .mk-foot{display:flex;align-items:center;gap:6px;margin-top:8px;justify-content:space-between;min-width:0}\n.mk-card .mk-foot .left{display:flex;align-items:center;gap:6px;min-width:0;flex-wrap:wrap}\n.mk-pill{font-size:10.5px;font-weight:700;padding:2px 7px;border-radius:5px;background:var(--surface-3);color:var(--text-2);white-space:nowrap;font-variant-numeric:tabular-nums}\n.mk-pill.late{background:var(--crit-wash);color:var(--critical)}\n.mk-pill.warn{background:var(--warn-wash);color:color-mix(in srgb,var(--warning) 60%,var(--text-1))}\n.mk-pill.wrap{white-space:normal;overflow-wrap:anywhere;text-align:left}\n.mk-prog{display:flex;align-items:center;gap:6px;font-size:10.5px;color:var(--muted);font-weight:700;font-variant-numeric:tabular-nums;white-space:nowrap}\n.mk-prog i{display:block;width:44px;height:4px;background:var(--surface-3);border-radius:3px;overflow:hidden}\n.mk-prog i b{display:block;height:100%;background:var(--good)}\n.mk-card .mk-actions{display:flex;gap:6px;margin-top:9px}\n.mk-card .mk-actions .btn{flex:1;justify-content:center;padding:6px 8px;font-size:12px;box-shadow:none}\n.btn.ok{background:var(--good)}.btn.ok:hover{background:#0a8a0a}\n.btn.danger{background:var(--surface-1);color:var(--critical);border:1px solid var(--critical);box-shadow:none}.btn.danger:hover{background:var(--crit-wash)}\n.mk-wait{font-size:11px;color:var(--muted);margin-top:8px;display:flex;align-items:center;gap:5px}\n.mk-newcard{width:100%;border:1px dashed var(--border);border-radius:8px;padding:9px;font-size:12.5px;font-weight:650;color:var(--text-2);margin-top:2px;transition:.12s}\n.mk-newcard:hover{border-color:var(--brand);color:var(--brand);background:var(--brand-wash)}\n.mk-cron{display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:12px}\n.mk-cron-card{background:var(--surface-1);border:1px solid var(--border);border-radius:var(--radius);padding:14px 15px;box-shadow:var(--shadow);min-width:0}\n.mk-cron-card .ch{display:flex;align-items:center;gap:8px;margin-bottom:6px;width:100%;text-align:left;font:inherit;cursor:pointer;border-radius:8px}\n.mk-cron-card .ch:hover{background:var(--surface-2)}\n.mk-cron-card .ch .grow{flex:1}\n.mk-cron-card .ct{display:block;width:100%;text-align:left;font:inherit;font-weight:700;font-size:13.5px;line-height:1.35;cursor:pointer;overflow-wrap:anywhere;margin-bottom:8px}\n.mk-cron-card .ct:hover{color:var(--brand)}\n.mk-step{display:flex;align-items:center;gap:8px;padding:6px 4px;border-bottom:1px solid var(--border-2);font-size:12.5px;min-width:0}\n.mk-step:last-child{border-bottom:none}\n.mk-step .st{flex:1;min-width:0;overflow-wrap:anywhere;cursor:pointer;text-align:left;font:inherit;padding:0}\n.mk-step button.st:hover{color:var(--brand)}\nbody[data-route=\"marketing\"] .minichk:disabled,#modal .minichk:disabled{cursor:default;opacity:.55}\n.mk-step.done .st{text-decoration:line-through;color:var(--muted)}\n.mk-step .sd{font-size:11px;color:var(--muted);font-variant-numeric:tabular-nums;white-space:nowrap}\n.mk-step .sd.late{color:var(--critical);font-weight:700}\n.mk-step .av.xs{width:18px;height:18px;font-size:8px;flex:0 0 auto}\n.mk-cron-foot{display:flex;align-items:center;gap:8px;margin-top:10px;justify-content:space-between;flex-wrap:wrap}\n.mk-cron-foot .mk-prog i{width:80px}\n.mk-rot{display:grid;grid-template-columns:repeat(7,minmax(0,1fr));gap:8px}\n.mk-rot-col{background:var(--surface-2);border:1px solid var(--border);border-radius:10px;padding:8px;min-height:90px;min-width:0}\n.mk-rot-col.today{border-color:var(--brand);box-shadow:0 0 0 1px var(--brand) inset;background:var(--surface-1)}\n.mk-rot-col h4{font-size:11.5px;color:var(--text-2);margin:0 0 6px;font-weight:700;display:flex;justify-content:space-between;align-items:center}\n.mk-rot-col h4 span{color:var(--muted);font-weight:600;font-variant-numeric:tabular-nums;font-size:10.5px}\n.mk-rot-col h4 .hj{background:var(--brand);color:#fff;font-size:9px;font-weight:800;padding:1px 6px;border-radius:10px;letter-spacing:.3px}\n.mk-rot-item{display:flex;align-items:flex-start;gap:7px;padding:6px 4px;border-radius:7px;cursor:pointer;font-size:12px;line-height:1.35;transition:.12s;min-width:0;width:100%;text-align:left;font-family:inherit}\n.mk-rot-item:hover{background:var(--surface-3)}\n.mk-rot-item .minichk{margin-top:1px}\n.mk-rot-item .rt{flex:1;min-width:0;overflow-wrap:anywhere}\n.mk-rot-item.done .rt{text-decoration:line-through;color:var(--muted)}\n.mk-rot-item .av.xs{width:16px;height:16px;font-size:7.5px;flex:0 0 auto;margin-top:1px}\n.mk-rot-empty{font-size:11px;color:var(--muted);text-align:center;padding:10px 4px}\n.mk-rot-bar{height:6px;background:var(--surface-3);border-radius:3px;overflow:hidden;width:120px}\n.mk-rot-bar b{display:block;height:100%;background:var(--good)}\n.mk-rot-hint,.mk-cal-hint{display:none}\n@media (max-width:760px){.mk-cal-hint{display:inline}}\n@media (max-width:1200px){.mk-rot-hint{display:inline}}\n.mk-cfg{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px}\n.mk-cfg-card{background:var(--surface-1);border:1px solid var(--border);border-radius:var(--radius);padding:14px 16px;box-shadow:var(--shadow);cursor:pointer;transition:.12s;text-align:left;min-width:0}\n.mk-cfg-card:hover{transform:translateY(-1px);border-color:var(--brand)}\n.mk-cfg-card{font:inherit;display:block;width:100%}\n.mk-cfg-card .h{font-size:13.5px;font-weight:700;display:flex;align-items:center;gap:8px}\n.mk-cfg-card .h .count{margin-left:auto;background:var(--surface-3);color:var(--text-2);font-size:11px;font-weight:700;padding:1px 8px;border-radius:10px}\n.mk-cfg-card .p{display:block;font-size:12px;color:var(--muted);margin-top:4px}\n.mk-cfg-card .prev{display:flex;gap:5px;flex-wrap:wrap;margin-top:10px}\n.modal.wide{max-width:980px}\n.mk-mhead{display:flex;align-items:center;gap:10px;padding:18px 22px;border-bottom:1px solid var(--border);flex-wrap:wrap}\n.mk-mhead .mk-num{font-size:13px;padding:3px 9px}\n.mk-mhead h3{font-size:17px;font-weight:750;flex:1 1 200px;min-width:0;overflow-wrap:anywhere}\n.mk-mhead .icon-btn{margin-left:auto;flex:0 0 auto}\n.mk-mhead .tag{font-size:11.5px}\n.mk-mgrid{display:grid;grid-template-columns:1.5fr 1fr;gap:20px;padding:20px 22px}\n.mk-mgrid>*{min-width:0}\n.mk-mgrid .col{display:flex;flex-direction:column;gap:15px}\n.mk-side{background:var(--surface-2);border:1px solid var(--border-2);border-radius:12px;padding:14px;display:flex;flex-direction:column;gap:13px}\n.mk-side .field label{font-size:11.5px}\n.mk-side .field input,.mk-side .field select{background:var(--surface-1);padding:8px 10px;font-size:13px}\n.mk-datebox{display:grid;grid-template-columns:1fr 1fr;gap:8px}\n.mk-datebox .db{background:var(--surface-1);border:1px solid var(--border);border-radius:8px;padding:8px 10px;min-width:0}\n.mk-datebox .db label{display:block;font-size:10.5px;font-weight:700;color:var(--muted);margin-bottom:3px;text-transform:uppercase;letter-spacing:.3px}\n.mk-datebox .db b{font-size:13px;font-weight:700;font-variant-numeric:tabular-nums}\n.mk-datebox .db b.late{color:var(--critical)}\n.mk-datebox .db small{display:block;font-size:10.5px;color:var(--muted)}\n.mk-datebox .db.auto{border-style:dashed}\n.mk-drive{display:flex;gap:6px;align-items:center}\n.mk-drive code{flex:1;min-width:0;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:12px;background:var(--surface-1);border:1px solid var(--border);border-radius:8px;padding:8px 10px;overflow-wrap:anywhere;line-height:1.4}\n.mk-chanpick{display:flex;flex-wrap:wrap;gap:7px}\n.mk-chanpick .chip-pick{gap:7px;padding:5px 11px 5px 5px;font-family:inherit}\n.mk-chanpick .chip-pick:disabled{cursor:default;opacity:.7}\n.mk-chanpick .chip-pick .ci{width:22px;height:22px;border-radius:6px;display:grid;place-items:center}\n.mk-chanpick .chip-pick .ci svg{width:13px;height:13px;fill:#fff}\n.mk-chanpick .chip-pick .ci .lt{color:#fff;font-size:10px;font-weight:900}\n.mk-chanpick .chip-pick.on::before{content:none}\n.mk-chanpick .chip-pick.on{box-shadow:0 0 0 2px var(--brand) inset}\n.mk-links .linkrow{display:flex;align-items:center;gap:6px;margin-bottom:6px}\n.mk-links .linkrow a{flex:1;min-width:0;display:flex;align-items:center;gap:8px;overflow:hidden;text-decoration:none;color:var(--brand);background:var(--surface-3);padding:7px 10px;border-radius:8px;font-size:12.5px;font-weight:600}\n.mk-links .linkrow a:hover{text-decoration:underline}\n.mk-links .linkrow a>span:first-child{min-width:0;overflow-wrap:anywhere;flex:1 1 auto}\n.mk-links .linkrow a .u{color:var(--muted);font-weight:400;font-size:11px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;min-width:0}\n.mk-links .linkrow a .ext{margin-left:auto;flex:0 0 auto;width:12px;height:12px;fill:none;stroke:currentColor;stroke-width:2}\n.mk-hist{display:flex;flex-direction:column;gap:8px}\n.mk-hist .h{display:flex;gap:9px;align-items:flex-start;font-size:12.5px;color:var(--text-2)}\n.mk-hist .h b{color:var(--text-1);font-weight:650}\n.mk-hist .h .when{color:var(--muted);font-size:11px}\n.mk-hist .h.rej{background:var(--crit-wash);color:var(--critical);padding:8px 10px;border-radius:8px}\n.mk-hist .h.rej b{color:var(--critical)}\n.mk-step-edit{display:flex;align-items:center;gap:7px;padding:6px 8px;border:1px solid var(--border);border-radius:9px;background:var(--surface-2);margin-bottom:6px}\n.mk-step-edit .st{flex:1;min-width:0;font-size:13px;overflow-wrap:anywhere;cursor:pointer;text-align:left;font-family:inherit;padding:0}\n.mk-step-edit button.st:hover{color:var(--brand)}\n.mk-step-edit .sx-group{display:inline-flex;gap:2px;flex:0 0 auto}\n.mk-step-edit .fase{font-family:inherit}\n.mk-step-edit.done .st{text-decoration:line-through;color:var(--muted)}\n.mk-step-edit input[type=date]{border:1px solid var(--border);border-radius:6px;padding:3px 6px;background:var(--surface-1);color:var(--text-1);font-size:11.5px;flex:0 0 118px;width:118px}\n.mk-step-edit select{border:1px solid var(--border);border-radius:6px;padding:3px 6px;background:var(--surface-1);color:var(--text-1);font-size:11.5px;max-width:110px}\n.mk-step-edit .sx{cursor:pointer;color:var(--muted);font-size:14px;padding:2px 5px;border-radius:5px;min-width:24px;font-family:inherit}\n.mk-step-edit .sx:hover{background:var(--surface-3);color:var(--text-1)}\n.mk-step-edit .fase{font-size:9.5px;font-weight:800;letter-spacing:.3px;padding:1px 6px;border-radius:4px;background:var(--surface-3);color:var(--muted);text-transform:uppercase}\n.mk-step-edit .fase.pos{background:var(--good-wash);color:color-mix(in srgb,var(--good) 65%,var(--text-1))}\n.mk-rejbox{background:var(--crit-wash);border:1px solid var(--critical);color:var(--critical);border-radius:10px;padding:10px 12px;font-size:12.5px;display:flex;gap:8px;align-items:flex-start}\n.mk-rejbox b{font-weight:800}\n.mk-rejbox .x{margin-left:auto;cursor:pointer;font-weight:800;flex:0 0 auto}\n.mk-list .li{cursor:pointer;border-radius:8px;padding:10px 8px;width:100%;text-align:left;font:inherit}\n.mk-list .li .t{display:flex;flex-direction:column}\n.mk-list .li .tt,.mk-list .li .ts{display:block}\n.mk-list .li:hover{background:var(--surface-2)}\n.mk-tabs{display:flex;gap:4px;background:var(--surface-3);border-radius:10px;padding:3px;margin-bottom:4px}\n.mk-tabs button{flex:1;padding:8px;border-radius:8px;font-weight:650;font-size:13px;color:var(--text-2)}\n.mk-tabs button.active{background:var(--surface-1);color:var(--text-1);box-shadow:0 1px 2px rgba(0,0,0,.08)}\n.mk-cfg-row{display:flex;align-items:center;gap:10px;padding:9px 6px;border-bottom:1px solid var(--border-2);min-width:0;width:100%;text-align:left;font:inherit}\nbutton.mk-cfg-row{cursor:pointer;border-radius:8px}button.mk-cfg-row:hover{background:var(--surface-2)}\n.mk-cfg-row:last-child{border-bottom:none}\n.mk-cfg-row .nm{flex:1;min-width:0;font-weight:600;font-size:13px;overflow-wrap:anywhere}\n.mk-cfg-row .nm small{display:block;color:var(--muted);font-weight:400;font-size:11.5px}\n.mk-cfg-row .swatch{width:16px;height:16px;border-radius:5px;flex:0 0 auto;border:1px solid var(--border)}\n.mk-cfg-row .icon-btn{flex:0 0 auto}\n.mk-sug{display:flex;align-items:center;gap:10px;padding:8px 10px;border:1px dashed var(--border);border-radius:9px;margin-bottom:6px;font-size:12.5px;width:100%;text-align:left;font-family:inherit}\nbutton.mk-sug{cursor:pointer}button.mk-sug:hover{border-color:var(--brand);background:var(--brand-wash)}\n.mk-sug .nm{flex:1;min-width:0}\n.mk-sug .nm small{color:var(--muted);font-size:11px;margin-left:6px}\n.mk-colorpick{display:flex;gap:6px;flex-wrap:wrap}\n.mk-colorpick button{width:24px;height:24px;border-radius:7px;cursor:pointer;border:2px solid transparent;padding:0}\n.mk-colorpick button.on{border-color:var(--text-1)}\n.mk-daypick{display:flex;gap:5px;flex-wrap:wrap}\n.mk-daypick .wkchip.on{background:var(--brand-wash);border-color:var(--brand);color:var(--brand);font-weight:700}\n.mk-dayhead{display:flex;align-items:center;gap:10px;flex-wrap:wrap}\n.mk-dayhead h3{font-size:17px;font-weight:750}\n.mk-empty{font-size:13px;color:var(--muted);padding:16px;text-align:center;border:1px dashed var(--border);border-radius:10px}\n.note-warn{font-size:12px;color:var(--warning);background:var(--warn-wash);padding:9px 12px;border-radius:8px}\n.mk-mini{display:flex;flex-direction:column;gap:8px}\n.mk-mini .row{display:flex;align-items:center;gap:8px;font-size:12.5px;padding:7px 0;border-bottom:1px solid var(--border-2);cursor:pointer;width:100%;text-align:left;font-family:inherit}\n.mk-mini .row:last-child{border-bottom:none}\n.mk-mini .row:hover{color:var(--brand)}\n.mk-mini .row .dt{font-weight:700;font-variant-numeric:tabular-nums;color:var(--text-2);width:44px;flex:0 0 auto}\n.mk-mini .row .tt{flex:1;min-width:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;font-weight:600}\n.mk-mini-kpis{display:flex;gap:8px;flex-wrap:wrap;margin-bottom:4px}\n.mk-mini-kpis button{font-size:11.5px;font-weight:700;padding:3px 9px;border-radius:20px;background:var(--surface-3);color:var(--text-2);display:inline-flex;align-items:center;gap:5px;cursor:pointer;font-family:inherit}\n.mk-mini-kpis button:hover{background:var(--brand-wash);color:var(--brand)}\n#mTitle:focus{outline:none}\n@media (max-width:1200px){\n.mk-rot{display:flex;overflow-x:auto;gap:8px;padding-bottom:6px}\n.mk-rot-col{min-width:170px;flex:0 0 170px}\n.mk-kpis{grid-template-columns:repeat(3,minmax(0,1fr))}\n.mk-kanban{grid-template-columns:repeat(3,minmax(0,1fr))}\n.mk-cfg{grid-template-columns:1fr}\n}\n@media (max-width:900px){\n.mk-kanban{grid-template-columns:repeat(2,minmax(0,1fr))}\n.mk-mgrid{grid-template-columns:1fr}\n}\n@media (max-width:760px){\n.mk-kpis{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}\n.mk-kpi{padding:11px 12px}.mk-kpi .k-val{font-size:22px}\n.mk-kanban{display:flex;overflow-x:auto;scroll-snap-type:x mandatory;gap:10px;padding-bottom:8px}\n.mk-kanban .kcol{flex:0 0 84%;scroll-snap-align:center}\n.mk-cal-grid{overflow-x:auto;grid-template-columns:repeat(7,minmax(96px,1fr))}\n.mk-cal-head{grid-template-columns:repeat(7,minmax(96px,1fr));overflow-x:auto}\n.mk-cell{min-height:84px}\n.mk-cron{grid-template-columns:1fr}\n.mk-alerts{grid-template-columns:1fr}\n.mk-monthbar .mk-mnav h2{min-width:130px;font-size:14px}\n.mk-datebox{grid-template-columns:1fr}\n.mk-mhead{display:grid;grid-template-columns:auto minmax(0,1fr) auto;align-items:center;gap:8px 10px}\n.mk-mhead .mk-num{grid-column:1}.mk-mhead h3{grid-column:2}.mk-mhead .icon-btn{grid-column:3}.mk-mhead .tag{grid-column:2;grid-row:2;justify-self:start}\n.mk-step-edit{flex-wrap:wrap}\n.mk-step-edit .st{flex:1 1 60%}\n.mk-step-edit select{flex:1 1 120px;max-width:none}\n.mk-step-edit .sx-group{margin-left:auto}\n}\n:root[data-theme=\"rosa\"]{\n--surface-1:#ffffff; --surface-2:#fff6f9; --surface-3:#fbe9f0;\n--page:#f8dfe9;\n--text-1:#2a1420; --text-2:#5c3f4d; --muted:#9a7a88;\n--grid:#f0d3de; --border:rgba(160,40,90,.16); --border-2:rgba(160,40,90,.09);\n--brand:#e23c8f; --brand-d:#c42577; --brand-wash:#fde0ec;\n--good:#0ca30c; --warning:#e0920a; --serious:#ec835a; --critical:#d03b3b;\n--good-wash:#e7f6e7; --warn-wash:#fdf1dc; --serious-wash:#fdeee7; --crit-wash:#fbe8e8;\n--shadow:0 1px 2px rgba(120,30,70,.06),0 4px 16px rgba(120,30,70,.10);\n}\n:root[data-theme=\"rosa\"] .topbar h1,:root[data-theme=\"rosa\"] .section-title h2{color:var(--brand)}\n:root[data-theme=\"rosa\"] .topbar{background:var(--surface-2)}\n:root[data-theme=\"rosa\"] .brand .logo{background:linear-gradient(135deg,var(--brand),#8e2a6a)}\n:root[data-theme=\"rosa\"] .mk-date{background:#c2185b;color:#fff}\n:root[data-theme=\"rosa\"] .mk-date.promo{background:#b45309;color:#fff}\n:root[data-theme=\"rosa\"] .mk-al-days.comem{background:#c2185b;color:#fff}\n:root[data-theme=\"rosa\"] .mk-al-days.promo{background:#b45309;color:#fff}\n:root[data-theme=\"rosa\"] .mk-cell.wknd:not(.out){background:#fff2f7}\nbody[data-route=\"marketing\"] :focus-visible,#modal :focus-visible{outline:2px solid var(--brand);outline-offset:2px}\n.mk-toque-hint{display:none}\n@media (max-width:760px){.mk-drag-hint{display:none}.mk-toque-hint{display:inline}}\nbody[data-route=\"marketing\"] .mk-rot-item.somente-leitura{cursor:default}\nbody[data-route=\"marketing\"] .mk-rot-item.somente-leitura:hover{background:transparent;border-color:var(--border)}\nbody[data-route=\"marketing\"] input.mk-ren,#modal input.mk-ren{flex:1;min-width:0;font:inherit;font-size:13px;padding:5px 8px;border:1px solid var(--brand);border-radius:7px;background:var(--surface-1);color:var(--text-1)}\nbody .mk-mini-kpis .mk-mini-lab{font-size:11.5px;color:var(--muted);font-weight:600;align-self:center;margin-right:2px}\n@media (min-width:761px) and (max-width:1200px){\nbody[data-route=\"marketing\"] .mk-ev .tt{white-space:normal;overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;line-height:1.25}\nbody[data-route=\"marketing\"] .mk-cell{min-height:104px}\n}\n#modal #mTitle:focus,#modal #mTitle:focus-visible{outline:none}\n.mk-toast{transition:bottom .18s ease}</style>");
  ...
  const ESTAGIOS = [
    ...
    { id: 'aprov', label: 'Aprovado', cor: '#2a78d6', desc: 'Aprovada e agendada. Alguém confirma quando for ao ar.' },
    { id: 'pub', label: 'Publicado', cor: '#0ca30c', desc: 'Já está no ar. Recebe a data de conclusão automaticamente.' }
  ];
  ...
  function icone(id, cls) {
    ...
    return '<span class="ci ' + (cls || '') + '" style="background:' + c.cor + '" title="' + esc(c.nome) + '" aria-label="' + esc(c.nome) + '">' + dentro + (c.badge ? '<span class="bd">' + esc(c.badge) + '</span>' : '') + '</span>';
  }
  ...
  const tagEstagio = p => { const s = estagio(p.stage), ov = atrasada(p); return '<span class="tag" style="' + (ov ? 'background:var(--crit-wash);color:var(--critical)' : corSuave(s.cor)) + '"><span class="dot" style="background:' + (ov ? 'var(--critical)' : s.cor) + '"></span>' + (ov ? 'Atrasada' : s.label) + '</span>'; };
  ...
  function telaMarketing() {
    ...
    return avisosHtml() + barraMesHtml() + buscaHtml(lista) + indicadoresHtml(lista) +
      calendarioHtml() + pipelineHtml(lista) + cronogramaHtml() + rotinaHtml() + cadastrosHtml();
  }
  ...
  function cardHtml(p) {
    ...
    return '<div class="mk-card" draggable="' + podeEditar() + '" data-num="' + p.num + '" onclick="MK.abrirPeca(' + p.num + ')" role="button" tabindex="0" onkeydown="if(event.key===\'Enter\')MK.abrirPeca(' + p.num + ')">' + faixa +
      '<div class="mk-ch"><span class="mk-num">#' + p.num + '</span><span class="mk-cat" style="' + corSuave(cat.cor) + '">' + esc(cat.nome) + '</span></div>' +
      '<div class="mk-title">' + esc(p.title) + '</div>' +
      '<div class="mk-chan">' + (p.canais.length ? p.canais.map(c => icone(c)).join('') : '<span class="mk-pill" style="color:var(--critical);background:var(--crit-wash)">sem canal</span>') + '</div>' +
  ...
  function cronogramaHtml() {
    ...
    return '<div class="mk-section"><div class="section-title"><h2>Cronograma de produção</h2><span class="st-sub">o que está em produção agora — ao mudar de coluna a peça sai daqui</span><div class="grow"></div>' +
      ...
      (itens.length ? '<div class="mk-cron">' + itens.map(p => {
        ...
        return '<div class="mk-cron-card"><button class="ch" onclick="MK.abrirPeca(' + p.num + ')"><span class="mk-num">#' + p.num + '</span><span class="mk-cat" style="' + corSuave(cat.cor) + '">' + esc(cat.nome) + '</span><span class="grow"></span>' +
  ...
  function cartaoPainel() {
    ...
    return '<div class="chartrow cr-bottom" style="margin-top:16px;order:6"><div class="card pad"><div class="section-title"><h2>📣 Marketing</h2><span class="st-sub">o que vai ao ar nos próximos 7 dias</span><div class="grow"></div><button class="btn ghost sm" onclick="go(\'marketing\')">Abrir aba</button></div>' +
      ...
      (late ? '<button style="color:var(--critical)" onclick="go(\'marketing\');MK.lista(\'late\')"><i class="dot" style="background:#d03b3b"></i>' + late + ' atrasada' + (late > 1 ? 's' : '') + '</button>' : '') + '</div>' +
    ...
    const monta = () => {
      ...
      const linhaEtapa = e => '<div class="mk-step-edit ' + (e.done ? 'done' : '') + '">' +
        ...
        (ed ? '<select onchange="MK.etapaRascunho(\'' + e.id + '\',\'resp\',this.value)" aria-label="Responsável da etapa"><option value="">quem?</option>' + opts(e.resp, ehMkt) + '</select>' +
          ...
          : (e.resp ? avatar(e.resp, 'xs') : '') + '<span class="sd" style="font-size:11px;color:var(--muted)">' + (e.date ? dm(e.date) : '') + '</span>') + '</div>';
      ...
      return '<div class="mk-mhead">' + (novo ? '<span class="mk-num" title="O número sai do banco ao salvar — nunca repete">#—</span>' : '<span class="mk-num">#' + x.num + '</span>') +
        ...
        (vaiAoArHoje(x) ? '<div style="padding:14px 22px 0"><div class="note-sm" style="background:var(--brand-wash);color:var(--brand);font-weight:650">Vai ao ar hoje — depois de postar, clique em "Confirmar publicação".</div></div>' : '') +
        (late ? '<div style="padding:14px 22px 0"><div class="note-sm" style="background:var(--crit-wash);color:var(--critical);font-weight:650">Estava marcada para ' + dmy(x.pub) + ' e ' + (x.stage === 'aprov' ? 'ninguém confirmou a publicação. Publicou? Confirme abaixo. Não vai publicar? Mude a data.' : 'ainda não está pronta. Mude a data ou termine a peça.') + '</div></div>' : '') +
        ...
        (!novo && ed ? '<button class="btn ghost" style="margin-right:auto;color:var(--critical)" onclick="MK.excluirPeca(' + x.num + ')">Excluir</button>' : '') +
    ...
    const monta = () => {
      ...
      return '<div class="modal-head"><h3 id="mTitle">' + (d ? esc(d.nome) : 'Nova data comemorativa ou promoção') + '</h3><div class="grow"></div>' +
        ...
        (!d && ed ? '<div class="field"><label>Sugestões do calendário comercial (' + sugestoesCache.length + ') <span style="font-weight:500;color:var(--muted)">— clique para preencher</span></label><div style="max-height:190px;overflow-y:auto">' +
          sugestoesCache.map((s, i) => '<button class="mk-sug" onclick="MK.usarSugestao(' + i + ')"><span class="mk-pill">' + dmy(s.date) + '</span><span class="nm">' + esc(s.nome) + '<small>' + (s.tipo === 'promocao' ? 'promoção' : 'comemorativa') + '</small></span><span style="color:var(--brand);font-weight:700;font-size:12px">usar</span></button>').join('') + '</div></div>' : '') +
        ...
        (d && ed ? '<button class="btn ghost" style="margin-right:auto;color:var(--critical)" onclick="MK.excluirData(\'' + d.id + '\')">Excluir</button><button class="btn ghost" onclick="MK.abrirPeca(null,\'' + d.date + '\',\'' + d.id + '\')">＋ Peça para esta data</button>' : '') +
      ...
      if (abaCfg === 'categorias') {
        if (edCfg) {
          corpo = '<div class="field"><label for="c_nome">Nome da categoria</label><input id="c_nome" value="' + esc(edCfg.nome) + '" maxlength="40" placeholder="Ex: Vídeo YouTube"></div>' +
            ...
            '<div class="modal-foot" style="padding:12px 0 0;border:0">' + (edCfg.id ? '<button class="btn ghost" style="margin-right:auto;color:var(--critical)" onclick="MK.cfgDelCat()">Excluir</button>' : '') +
        ...
        if (edCfg) {
          corpo = '<div class="field-row"><div class="field"><label for="k_nome">Nome do canal</label><input id="k_nome" value="' + esc(edCfg.nome) + '" maxlength="30" placeholder="Ex: Kwai"></div>' +
            ...
            '<div class="field"><label>Logo</label><div class="mk-chanpick">' + Object.keys(ICONES).map(k => '<button class="chip-pick ' + (edCfg.icon === k ? 'on' : '') + '" onclick="MK.cfgSet(\'icon\',\'' + k + '\')"><span class="ci" style="background:' + edCfg.cor + '"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="' + ICONES[k] + '"/></svg></span>' + k + '</button>').join('') +
            '<button class="chip-pick ' + (!edCfg.icon ? 'on' : '') + '" onclick="MK.cfgSet(\'icon\',\'\')"><span class="ci" style="background:' + edCfg.cor + '"><span class="lt">' + esc((edCfg.nome || '?')[0].toUpperCase()) + '</span></span>sem logo (inicial)</button></div>' +
            ...
            '<div class="modal-foot" style="padding:12px 0 0;border:0">' + (edCfg.id ? '<button class="btn ghost" style="margin-right:auto;color:var(--critical)" onclick="MK.cfgDelCanal()">Excluir</button>' : '') +
          ...
          corpo = '<div class="note-sm">Redes sociais e marketplaces numa lista só. Uma peça pode ir ao ar em vários canais.</div>' +
            M.canais.map(c => '<div class="mk-cfg-row"><span class="mk-chan">' + icone(c.id, 'big') + '</span><div class="nm">' + esc(c.nome) + '<small>' + (c.tipo === 'marketplace' ? 'marketplace' : 'rede social') + ' · ' + nPecas(M.pecas.filter(p => p.canais.includes(c.id)).length) + (limpaUrl(c.url) ? ' · <a href="' + esc(limpaUrl(c.url)) + '" target="_blank" rel="noopener noreferrer" style="color:var(--brand)">perfil ↗</a>' : '') + '</small></div>' + (ed ? '<button class="btn ghost sm" onclick="MK.cfgEditCanal(\'' + c.id + '\')">Editar</button>' : '') + '</div>').join('') +
  ...
  window.MK = {
    ...
    cfgEditCanal: id => { if (!podeEditar()) return; sincCfg(); const c = M.canais.find(x => x.id === id); edCfg = c ? { id: c.id, nome: c.nome, cor: c.cor, icon: c.icon || '', tipo: c.tipo, url: c.url || '' } : { id: null, nome: '', cor: '#2a78d6', icon: '', tipo: 'rede', url: '' }; atualizarModal(); },
    cfgEtapa: (i, op) => {
